      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <label>User</label>
            <select class="form-control" id="filter_user" name="filter_user" onchange="fun_refresh('<?= $_GET['pekerjaan_id'] ?>', this.value)">
              ...
              <?php foreach ($data_disposisi as $value) : ?>
                ...
                ?>
                <option value="<?= $value['id_user'] . '~' . $value['pekerjaan_disposisi_status'] ?>" <?php if ($_GET['id_user'] == $value['id_user'] && $_GET['status'] == $value['pekerjaan_disposisi_status']) echo 'selected' ?>><?= $tree . $value['pegawai_nama'] ?></option>
              <?php endforeach ?>
            </select>

            <?php if ($data_selesai['total'] > 0) : ?>
              <label>CC Selesai</label>
              <select class="form-control" id="filter_user" name="filter_user" onchange="fun_refresh_cc('<?= $_GET['pekerjaan_id'] ?>', this.value)">
                <option value="">- Pilih User -</option>
                <?php foreach ($data_disposisi_cc as $value) : ?>
                  ...
                  for ($j = 0; $j < $value['pekerjaan_disposisi_status']; $j++) $tree .= ". ";
                  ?>
                  <option value="<?= $value['id_user'] . '~' . $value['pekerjaan_disposisi_status'] ?>" <?php if ($_GET['id_user_cc'] == $value['id_user'] && $_GET['status'] == $value['pekerjaan_disposisi_status']) echo 'selected' ?>><?= $tree . $value['pegawai_nama'] ?></option>
                <?php endforeach ?>
              </select>
            <?php endif; ?>
          </div>
            ...
            <div class="row task-dates">
              ...
              <?php if ($_GET['aksi'] == 'usulan') : ?>
                ...
                <div id="btn_disposisi_vp" class="col-sm-4 col-md-3" style="display: none;">
                  <div class="mt-4">
                    <button type="button" class="btn btn-primary col-10" onclick="fun_disposisi_vp('<?= $_GET['pekerjaan_id'] ?>')">Disposisi ke AVP</button>
                  </div>
                </div>
              ...
              <?php elseif ($_GET['aksi'] == 'ifc') : ?>
                ...
                <div class="col-sm-4 col-md-3" id="btn_upload_ifc_hps" style="display: none;">
                  <div class="mt-4">
                    <button type="button" class="btn btn-success col-10" onclick="fun_upload_ifc_hps('<?= $this->input->get('pekerjaan_id') ?>','<?= $_GET['status'] ?>')">Upload Dok Internal</button>
                  </div>
                </div>
                <div class="col-sm-4 col-md-3" id="btn_upload_ifc" style="display: none;">
                  <div class="mt-4">
                    <button type="button" class="btn btn-success col-10" onclick="fun_upload_ifc('<?= $this->input->get('pekerjaan_id') ?>','<?= $_GET['status'] ?>')">Upload Dokumen</button>
                  </div>
                </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <button type="button" class="btn btn-danger col-1 float-end" id="btn_revisi" onclick="fun_reject_berjalan('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')" style="display: none;">Revisi</button>

                <button type="button" class="btn btn-success col-2 float-end" id="btn_approve_ifa" onclick="fun_approve_ifa('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>', 'Apakah Anda Yakin Approved?')" style="display: none;">Approve IFA</button>
                ...
                <button type="button" class="btn btn-danger col-1 float-end" id="btn_revisi_ifa" onclick="fun_reject_ifa('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')" style="display: none;">Revisi IFA</button>
                <button type="button" class="btn btn-danger col-1 float-end" id="btn_revisi" onclick="fun_reject_berjalan_ifa('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')" style="display: none;">Revisi</button>
                <!-- Tombol -->
              </div>
            </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <button type="button" class="btn btn-info col-2 float-end" onclick="funcModalSendVPKoor(<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>)" id="btn_send_avp_koor" style="display:none">
                  Send VP Koor
                </button>
                <button type="button" class="btn btn-success col-2 float-end" onclick="funcModalApproveVP(<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>)" id="btn_approve_vp" style="display:none">
                  Approve VP
...
<script type="text/javascript">
  ...
  $(function() {
    $.getJSON('<?= base_url('project/pekerjaan_langsung/getPekerjaan') ?>', {
      ...
      if ('<?= $_GET['aksi'] ?>' == 'usulan') {
        ...
        if (json.pekerjaan_disposisi_status == '1') {
          ...
          $('#btn_reject').css('display', 'block');
          $('#btn_reject_avp').css('display', 'none');
          // } else if (json.pekerjaan_disposisi_status == '4' && json.is_proses == 'y') {
        ...
        /* Berjalan */
        // if (json.pekerjaan_disposisi_status == '5' && json.pekerjaan_disposisi_status == '6' && json.is_proses == 'y' && json.id_penanggung_jawab == 'y') {
        //   /* Reviewed AVP Cangun */
        ...
        // } else if (json.pekerjaan_disposisi_status == '5' && json.pekerjaan_disposisi_status == '6' && json.is_proses == 'y') {
        //   /* Reviewed AVP Cangun */
        //   $('#btn_upload').css('display', 'none');
        //   $('#btn_upload_hps').css('display', 'none');
        //   $('#btn_progress').css('display', 'none');
        ...
        //   $('#btn_reject_staf').hide();
        //   $('#btn_ganti_perencana').hide();
        // } else if (json.pekerjaan_disposisi_status == '5' && json.pekerjaan_disposisi_status == '6' && json.is_proses == 'r') {
        //   /* Reviewed AVP Cangun */
        //   $('#btn_upload').css('display', 'none');
        //   $('#btn_upload_hps').css('display', 'none');
        //   $('#btn_progress').css('display', 'none');
        ...
        //   $('#btn_ganti_perencana').hide();
        /* Reviewed AVP Cangun */
        // } else if (json.pekerjaan_disposisi_status == '5' && json.pekerjaan_disposisi_status == '6' && json.is_proses == null) {
        //   /* Reviewed AVP Cangun */
        //   $('#btn_upload').css('display', 'none');
        //   $('#btn_upload_hps').css('display', 'none');
        //   $('#btn_progress').css('display', 'none');
        ...
        //   $('#btn_reject_staf').hide();
        //   $('#btn_ganti_perencana').hide();
        // if (json.pekerjaan_disposisi_status == '5' && json.pekerjaan_disposisi_status == '6' && json.id_penanggung_jawab == 'y') {
        //   /* Reviewed AVP Cangun */
        //   $('#btn_upload').css('display', 'none');
        //   $('#btn_upload_hps').css('display', 'none');
        //   $('#btn_progress').css('display', 'none');
        ...
        //   $('#btn_reject_staf').hide();
        //   $('#btn_ganti_perencana').hide();
        // } else if (json.pekerjaan_disposisi_status == '5' && json.pekerjaan_disposisi_status == '6' && json.id_penanggung_jawab == 'n') {
        //   /* Reviewed AVP Cangun */
        //   $('#btn_upload').css('display', 'none');
        //   $('#btn_upload_hps').css('display', 'none');
        //   $('#btn_progress').css('display', 'none');
        ...
        // } else if (json.pekerjaan_disposisi_status == '5' && json.is_proses == 'y') {
        //   $('#btn_upload').css('display', 'none');
        //   $('#btn_upload_hps').css('display', 'none');
        //   $('#btn_progress').css('display', 'none');
        //   $('#btn_send_avp').css('display', 'none');
        ...
        if (json.pekerjaan_disposisi_status == '5') {
          ...
          /* Upload File Staf Cangun */
          // } else if (json.pekerjaan_disposisi_status == '6' && json.is_proses == 'y' && json.id_penanggung_jawab == 'y') {
          //   /* Reviewed AVP Cangun */
          //   $('#btn_upload').css('display', 'none');
          //   $('#btn_upload_hps').css('display', 'none');
          //   $('#btn_progress').css('display', 'none');
          ...
          //   $('#btn_reject_staf').hide();
          //   $('#btn_ganti_perencana').hide();
          // } else if (json.pekerjaan_disposisi_status == '6' && json.is_proses == 'y') {
          //   /* Reviewed AVP Cangun */
          //   $('#btn_upload').css('display', 'none');
          //   $('#btn_upload_hps').css('display', 'none');
          //   $('#btn_progress').css('display', 'none');
          ...
          //   $('#btn_reject_staf').hide();
          //   $('#btn_ganti_perencana').hide();
          // } else if (json.pekerjaan_disposisi_status == '6' && json.is_proses == 'r') {
          //   /* Reviewed AVP Cangun */
          //   $('#btn_upload').css('display', 'none');
          //   $('#btn_upload_hps').css('display', 'none');
          //   $('#btn_progress').css('display', 'none');
          ...
          $('#btn_ganti_perencana').hide();
          /* Approve VP Cangun */
          // } else if (json.pekerjaan_disposisi_status == '8' && json.is_proses == 'y') {
          //   /* Approve PIC */
          //   $('#btn_upload').css('display', 'none');
          //   $('#btn_upload_hps').css('display', 'none');
          //   $('#btn_progress').css('display', 'none');
          ...
          $('#btn_ganti_perencana').hide();
          /* Approve PIC */
          // } else if (json.pekerjaan_disposisi_status == '9' && json.pekerjaan_disposisi_status == '9' && json.is_proses == 'y') {
          //   /* Upload File Staf Cangun */
          ...
          //   $('#btn_revisi').css('display', 'none');
          //   $('#btn_reject_staf').hide();
          // } else if (json.pekerjaan_disposisi_status == '9' && json.pekerjaan_disposisi_status == '10' && json.is_proses == 'y') {
          //   /* Upload File Staf Cangun */
          //   $('#btn_upload_ifc').css('display', 'none');
          //   $('#btn_progress').css('display', 'none');
          //   $('#btn_send_avp_ifc').hide();
          ...
          //   $('#btn_reject_staf').hide();
          //   $('#btn_ganti_perencana').hide();
          // } else if (json.pekerjaan_disposisi_status == '9' && json.pekerjaan_disposisi_status == '10') {
          //   /* Upload File Staf Cangun */
          //   $('#btn_upload_ifc').css('display', 'none');
          //   $('#btn_progress').css('display', 'none');
    ...
    $('#table_dokumen').DataTable({
      "ajax": {
        "url": "<?= base_url('project/pekerjaan_usulan/') ?>getDokumenBerjalan?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=n&id_user=<?= $_GET['id_user'] ?>",
        "dataSrc": ""
      },
      "columns": [{
          render: function(data, type, full, meta) {
        ...
        },
        {
          "render": function(data, type, full, meta) {
            // console.log(full);
            // console.log($('#session_bagian').val());
            var aksi = '';
    ...
    $('#table_dokumen_hps').DataTable({
      "ajax": {
        "url": "<?= base_url('project/pekerjaan_usulan/') ?>getDokumenBerjalan?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&id_user=<?= $_GET['id_user'] ?>&is_hps=y",
        "dataSrc": ""
      },
      "columns": [{
          render: function(data, type, full, meta) {
    ...
    $('#table_dokumen_ifa').DataTable({
      "ajax": {
        "url": "<?= base_url('project/pekerjaan_usulan/') ?>getDokumenIFA?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&id_user=<?= $_GET['id_user'] ?>&is_hps=n",
        "dataSrc": ""
      },
      "columns": [{
          render: function(data, type, full, meta) {
    ...
    $('#table_dokumen_ifa_hps').DataTable({
      "ajax": {
        "url": "<?= base_url('project/pekerjaan_usulan/') ?>getDokumenIFAHPS?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=y&id_user=<?= $_GET['id_user'] ?>",
        "dataSrc": ""
      },
      "columns": [{
          render: function(data, type, full, meta) {
    ...
    $('#table_dokumen_ifc').DataTable({
      "ajax": {
        "url": "<?= base_url('project/pekerjaan_usulan/') ?>getDokumenIFC?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=n&id_user=<?= $_GET['id_user'] ?>",
        "dataSrc": ""
      },
      "columns": [{
          render: function(data, type, full, meta) {
    ...
    $('#table_dokumen_ifc_hps').DataTable({
      "ajax": {
        "url": "<?= base_url('project/pekerjaan_usulan/') ?>getDokumenIFC?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=y&id_user=<?= $_GET['id_user'] ?>",
        "dataSrc": ""
      },
      "columns": [{
          render: function(data, type, full, meta) {
    ...
    $('#table_dokumen_selesai').DataTable({
      "ajax": {
        "url": "<?= base_url('project/pekerjaan_usulan/') ?>getDokumenSelesai?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=n&id_user=<?= $_GET['id_user'] ?>&id_user_cc=<?= $_GET['id_user_cc'] ?>",
        "dataSrc": ""
      },
      "columns": [{
          render: function(data, type, full, meta) {
    ...
    $('#table_dokumen_selesai_ifa').DataTable({
      "ajax": {
        "url": "<?= base_url('project/pekerjaan_usulan/') ?>getDokumenSelesaiIFA?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&id_user=<?= $_GET['id_user'] ?>&id_user_cc=<?= $_GET['id_user_cc'] ?>&is_hps=n",
        "dataSrc": ""
      },
      "columns": [{
          render: function(data, type, full, meta) {
    ...
    $('#table_dokumen_selesai_hps').DataTable({
      "ajax": {
        "url": "<?= base_url('project/pekerjaan_usulan/') ?>getDokumenSelesaiHPS?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=y&id_user=<?= $_GET['id_user'] ?>&id_user_cc=<?= $_GET['id_user_cc'] ?>",
        "dataSrc": ""
      },
      "columns": [{
          render: function(data, type, full, meta) {
    ...
    $('#id_user_avp').select2({
      ...
      ajax: {
        delay: 250,
        url: '<?= base_url('project/pekerjaan_langsung/getUserListAVP?pekerjaan_id=' . $_GET['pekerjaan_id'] . '&user_id=' . $_GET['id_user']) ?>',
        dataType: 'json',
        type: 'GET',
        data: function(params) {
          var queryParameters = {
    ...
    $('#id_perencana_baru').select2({
      ...
      ajax: {
        delay: 250,
        url: '<?= base_url('project/pekerjaan_usulan/getUserPengganti') ?>?id_user=<?= $_GET['id_user'] ?>',
        dataType: 'json',
        type: 'GET',
        data: function(params) {
          var queryParameters = {
    ...
    fun_loading();
    fun_cekRevisiIFA('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>'); // rubah mamas
  });
  ...
  function fun_reject(id) {
    Swal.fire({
      ...
      if (result.value) {
        ...
        // window.location.replace('<?= base_url() ?>project/pekerjaan_usulan');
        setTimeout(() => {
          if ($('#is_rkap').val() == '1') {
            window.location.replace('<?= base_url() ?>project/RKAP');
          } else {
  ...
  function fun_disposisi_vp(id) {
    ...
    $.getJSON('<?= base_url('project/pekerjaan_langsung/getVPPJ') ?>', {
      ...
      $.each(json, function(index, val) {
        $('#' + index).val(val);
        // console.log(val);
        $('#id_tanggung_jawab_vp').append('<option selected value="' + val.id_user + '">' + val.pegawai_nama + '-' + val.pegawai_postitle + '</option>');
      });
    });
    ...
    $.getJSON('<?= base_url('project/pekerjaan_langsung/getVPTerkait') ?>', {
      ...
      $.each(json, function(index, val) {
        $('#' + index).val(val);
        // console.log(val);
        $('#id_user_vp').append('<option selected value="' + val.id_user + '">' + val.pegawai_nama + '-' + val.pegawai_postitle + '</option>');
      });
    })
  }
  /* Klik Disposisi VP */
  ...
  function fun_upload(id, val) {
    ...
    setTimeout(function() {
      $('#dg_document').edatagrid({
        url: '<?= base_url("project/pekerjaan_usulan/getAsetDocument?pekerjaan_dokumen_status=n&id_pekerjaan=") ?>' + id + '&pekerjaan_status=' + val + '&id_create=' + $('#session_user').val() + '&is_hps=n&id_user=<?= $_GET['id_user'] ?>',
        saveUrl: '<?= base_url('project/pekerjaan_usulan/insertAsetDocument?id_user=') ?><?= $_GET['id_user'] ?>',
        updateUrl: '<?= base_url('project/pekerjaan_usulan/updateAsetDocument?id_user=') ?><?= $_GET['id_user'] ?>',
  ...
  function fun_upload_hps(id, val) {
    ...
    setTimeout(function() {
      $('#dg_document_hps').edatagrid({
        url: '<?= base_url("project/pekerjaan_usulan/getAsetDocument?pekerjaan_dokumen_status=n&id_pekerjaan=") ?>' + id + '&pekerjaan_status=' + val + '&id_create=' + $('#session_user').val() + '&is_hps=y&id_user=<?= $_GET['id_user'] ?>',
        saveUrl: '<?= base_url('project/pekerjaan_usulan/insertAsetDocument?id_user=') ?><?= $_GET['id_user'] ?>',
        updateUrl: '<?= base_url('project/pekerjaan_usulan/updateAsetDocument?id_user=') ?><?= $_GET['id_user'] ?>',
        rowStyler: function(index, row) {
          if (row.pekerjaan_dokumen_status == '0') {
  ...
  function fun_upload_ifc(id, val) {
    ...
    setTimeout(function() {
      $('#dg_document_ifc').edatagrid({
        url: '<?= base_url("project/pekerjaan_usulan/getAsetDocumentIFC?pekerjaan_dokumen_status=n&id_pekerjaan=") ?>' + id + '&pekerjaan_status=' + val + '&id_user=<?= $_GET['id_user'] ?>&id_create=' + $('#session_user').val() + '&is_hps=n&id_user=<?= $_GET['id_user'] ?>',
        saveUrl: '<?= base_url('project/pekerjaan_usulan/insertAsetDocumentIFC?id_user=') ?><?= $_GET['id_user'] ?>',
        updateUrl: '<?= base_url('project/pekerjaan_usulan/updateAsetDocumentIFC?id_user=') ?><?= $_GET['id_user'] ?>',
        rowStyler: function(index, row) {
          if (row.pekerjaan_dokumen_status == '0') {
            return 'background-color:#FF0000;font-weight:bold;';
          }
  ...
  function fun_upload_ifc_hps(id, val) {
    ...
    setTimeout(function() {
      $('#dg_document_ifc_hps').edatagrid({
        ...
        url: '<?= base_url("project/pekerjaan_usulan/getAsetDocumentIFC?pekerjaan_dokumen_status=n&id_pekerjaan=") ?>' + id + '&pekerjaan_status=' + val + '&id_create=' + $('#session_user').val() + '&is_hps=y&id_user=<?= $_GET['id_user'] ?>',
        saveUrl: '<?= base_url('project/pekerjaan_usulan/insertAsetDocumentIFC?id_user=') . $_GET['id_user'] ?>',
        updateUrl: '<?= base_url('project/pekerjaan_usulan/updateAsetDocumentIFC?id_user=') . $_GET['id_user'] ?>',
        rowStyler: function(index, row) {
          if (row.pekerjaan_dokumen_status == '0') {
  ...
  function fun_approve_berjalan(id, text) {
    Swal.fire({
      ...
      if (result.value) {
        // window.location.replace('<?= base_url() ?>project/pekerjaan_berjalan');
        setTimeout(() => {
          if ($('#is_rkap').val() == '1') {
            window.location.replace('<?= base_url() ?>project/RKAP');
          } else {
        ...
        $.getJSON('<?= base_url('project/pekerjaan_usulan/prosesApproveBerjalan') ?>?id_user=<?= $_GET['id_user'] ?>', {
          pekerjaan_id: id,
          pekerjaan_status: $('#pekerjaan_status').val(),
  ...
  function fun_approve_berjalan_ifc(id, text) {
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.getJSON('<?= base_url('project/pekerjaan_usulan/prosesApproveBerjalanIFC?id_user=' . $_GET['id_user']) ?>', {
          pekerjaan_id: id,
          pekerjaan_status: $('#pekerjaan_status').val(),
          id_user_staf: $('#id_user_staf').val(),
        }, function(json) {});
  ...
  function fun_approve_ifa(id, text) {
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.getJSON('<?= base_url('project/pekerjaan_usulan/prosesApproveIFA?id_user=' . $_GET['id_user']) ?>', {
          pekerjaan_id: id,
          pekerjaan_status: $('#pekerjaan_status').val(),
          id_user: '<?= $_GET['id_user'] ?>',
        }, function(json) {
  ...
  function fun_reject_ifa(id) {
    Swal.fire({
      ...
      if (result.value) {
        // window.location.replace('<?= base_url() ?>project/dokumen_IFA');
        setTimeout(() => {
          if ($('#is_rkap').val() == '1') {
            window.location.replace('<?= base_url() ?>project/RKAP');
          } else {
  ...
  $("#form_modal_vp").on("submit", function(e) {
    var url = '<?= base_url('project/pekerjaan_usulan/disposisiVP') ?>?id_user=<?= $_GET['id_user'] ?>';
  ...
  $("#form_modal_avp").on("submit", function(e) {
    var url = '<?= base_url('project/pekerjaan_usulan/disposisiAVP') ?>?id_user=<?= $_GET['id_user'] ?>';
    e.preventDefault();
    Swal.fire({
  ...
  $('#form_modal_ganti_perencana').on('submit', function(e) {
    ...
    $.ajax({
      url: '<?= base_url('project/pekerjaan_usulan/gantiPerencana') ?>?id_user=<?= $_GET['id_user'] ?>',
      data: data,
      dataType: 'HTML',
      type: 'POST',
      processData: false,
  ...
  $('#simpan_progress').on('click', function(e) {
    var url = '<?= base_url('project/pekerjaan_usulan/insertProgressPekerjaan') ?>?id_user=<?= $_GET['id_user'] ?>';
    e.preventDefault();
  ...
  $('#edit_progress').on('click', function(e) {
    var url = '<?= base_url('project/pekerjaan_usulan/updateProgressPekerjaan') ?>?id_user=<?= $_GET['id_user'] ?>';
    e.preventDefault();
  ...
  $("#form_modal_aksi").on("submit", function(e) {
    var url = '<?= base_url('project/pekerjaan_usulan/simpanAksi') ?>?id_user=<?= $_GET['id_user'] ?>';
  ...
  $("#form_modal_aksi_cc").on("submit", function(e) {
    var url = '<?= base_url('project/pekerjaan_usulan/simpanAksiCC') ?>?id_user=<?= $_GET['id_user'] ?>';
  ...
  $("#form_modal_aksi_staf").on("submit", function(e) {
    var url = '<?= base_url('project/pekerjaan_usulan/simpanAksiStaf') ?>?id_user=<?= $_GET['id_user'] ?>';
  ...
  $("#form_modal_aksi_ifa").on("submit", function(e) {
    var url = '<?= base_url('project/pekerjaan_usulan/simpanAksiIFA') ?>?id_user=<?= $_GET['id_user'] ?>';
  ...
  $("#form_modal_aksi_ifa_cc").on("submit", function(e) {
    var url = '<?= base_url('project/pekerjaan_usulan/simpanAksiIFACC') ?>?id_user=<?= $_GET['id_user'] ?>';
  ...
  $("#form_modal_aksi_ifc").on("submit", function(e) {
    var url = '<?= base_url('project/pekerjaan_usulan/simpanAksiIFC') ?>?id_user=<?= $_GET['id_user'] ?>';
  ...
  $('#form_modal_send_vp').on('submit', function(e) {
    e.preventDefault();
    var url = '<?= base_url('project/pekerjaan_usulan/prosesSendVP') ?>?id_user=<?= $_GET['id_user'] ?>';
    $.ajax({
      url: url,
  ...
  $('#form_modal_send_avp_ifc').on('submit', function(e) {
    e.preventDefault();
    var url = '<?= base_url('project/pekerjaan_usulan/prosesSendAVPIFC?id_user=' . $_GET['id_user']) ?>';
    $.ajax({
      url: url,
      // data: $('#form_modal_send_vp').serialize(),
      data: {
  ...
  $('#form_modal_send_vp_ifc').on('submit', function(e) {
    e.preventDefault();
    var url = '<?= base_url('project/pekerjaan_usulan/prosesSendVPIFC?id_user=') . $_GET['id_user'] ?>';
    $.ajax({
      url: url,
      // data: $('#form_modal_send_vp').serialize(),
      data: {
  ...
  $('#form_modal_approve_vp').on('submit', function(e) {
    e.preventDefault();
    var url = '<?= base_url('project/pekerjaan_usulan/prosesApproveVP?id_user=') . $_GET['id_user'] ?>';
    $.ajax({
      url: url,
      // data: $('#form_modal_approve_vp').serialize(),
      data: {
  ...
  function funcModalSendAVPIFC(id) {
    ...
    $.getJSON('<?= base_url('project/pekerjaan_usulan/getUserKoorVPIFC?id_user=' . $_GET['id_user']) ?>', {
      pekerjaan_id: id,
      status: '<?= $_GET['status'] ?>',
    }, function(json, result) {
      if (json.id_penanggung_jawab == 'n') {
  ...
  function fun_draft_dokumen(id) {
    ...
    if ($('#dg_document').data('datagrid').data.total > 0 && 'isNewRecord' in isi_awal) {
      ...
      $.ajax({
        url: '<?= base_url('project/pekerjaan_usulan/insertCCDraft?id_user=' . $_GET['id_user']) ?>',
  ...
  function fun_draft_dokumen_hps(id) {
    ...
    if ($('#dg_document_hps').data('datagrid').data.total > 0 && 'isNewRecord' in isi_awal) {
      ...
      $.ajax({
        url: '<?= base_url('project/pekerjaan_usulan/insertCCDraftHPS?id_user=' . $_GET['id_user']) ?>',
