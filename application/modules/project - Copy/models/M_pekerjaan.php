...
class M_pekerjaan extends CI_Model
{
  ...
  public function getPekerjaan($data = null)
  {
    ...
    // if (isset($data['user_disposisi']) != '2190626') {
    ...
    // if (isset($data['user_disposisi'])) $this->db->where('e.id_user', $data['user_disposisi']);
    // if (isset($data['user_disposisi'])) $this->db->or_where('a.pic', $data['user_disposisi']);
    // if (isset($data['user_pic'])) $this->db->where('e.id_user', $data['user_pic']);
    // if (isset($data['user_pic'])) $this->db->or_where('a.pic', $data['user_pic']);
    // }
  ...
  public function getPekerjaanDispo($data = null)
  {
    ...
    // if (isset($data['user_disposisi'])) $this->db->where('e.id_user', $data['user_disposisi']);
    // if (isset($data['user_pic'])) $this->db->where('a.pic', $data['user_pic']);
  ...
  {
    $this->db->select('pekerjaan_dokumen_revisi');
  ...
  {
    $this->db->query("INSERT INTO dec.dec_pekerjaan_dokumen SELECT '" . $data['pekerjaan_dokumen_id'] . "', id_pekerjaan, '" . $data['pekerjaan_dokumen_file'] . "', id_pekerjaan_disposisi, pekerjaan_dokumen_nama, pekerjaan_dokumen_awal, '" . $data['pekerjaan_dokumen_status'] . "', '" . $data['pekerjaan_dokumen_keterangan'] . "', who_create, is_lama, id_pekerjaan_template ,'" . $data['pekerjaan_dokumen_revisi'] . "',pekerjaan_dokumen_status_review,'" . $data['id_create'] . "' , is_hps, '" . $data['is_proses'] . "', id_create_awal,pekerjaan_dokumen_nomor,pekerjaan_dokumen_cc,is_review, pekerjaan_dokumen_jumlah,pekerjaan_dokumen_jenis,id_bidang,id_urutan_proyek,id_section_area,'" . $data['pekerjaan_dokumen_waktu'] . "' FROM dec.dec_pekerjaan_dokumen WHERE pekerjaan_dokumen_id = '" . $data['pekerjaan_dokumen_id_temp'] . "'");
  ...
  {
    $this->db->query("INSERT INTO dec.dec_pekerjaan_dokumen SELECT '" . $data['pekerjaan_dokumen_id'] . "', id_pekerjaan, '" . $data['pekerjaan_dokumen_file'] . "', id_pekerjaan_disposisi, '" . $data['pekerjaan_dokumen_nama'] . "', pekerjaan_dokumen_awal, '" . $data['pekerjaan_dokumen_status'] . "', '" . $data['pekerjaan_dokumen_keterangan'] . "', who_create, is_lama, id_pekerjaan_template ,pekerjaan_dokumen_revisi,pekerjaan_dokumen_status_review,'" . $data['id_create'] . "' , is_hps, '" . $data['is_proses'] . "', id_create_awal,pekerjaan_dokumen_nomor,pekerjaan_dokumen_cc,is_review, pekerjaan_dokumen_jumlah,pekerjaan_dokumen_jenis,id_bidang,id_urutan_proyek,id_section_area,pekerjaan_dokumen_waktu FROM dec.dec_pekerjaan_dokumen WHERE pekerjaan_dokumen_id = '" . $data['pekerjaan_dokumen_id_temp'] . "'");
  ...
  {
    $this->db->query("INSERT INTO dec.dec_pekerjaan_dokumen SELECT '" . $data['pekerjaan_dokumen_id'] . "', id_pekerjaan, '" . $data['pekerjaan_dokumen_file'] . "', id_pekerjaan_disposisi, pekerjaan_dokumen_nama, pekerjaan_dokumen_awal, pekerjaan_dokumen_status, '" . $data['pekerjaan_dokumen_keterangan'] . "', who_create, is_lama, id_pekerjaan_template ,'" . $data['pekerjaan_dokumen_revisi'] . "','" . $data['pekerjaan_dokumen_status_review'] . "','" . $data['id_create'] . "' , is_hps,is_proses, id_create_awal,pekerjaan_dokumen_nomor,pekerjaan_dokumen_cc ,'" . $data['is_review'] . "', pekerjaan_dokumen_jumlah,pekerjaan_dokumen_jenis,id_bidang,id_urutan_proyek,id_section_area,pekerjaan_dokumen_waktu FROM dec.dec_pekerjaan_dokumen WHERE pekerjaan_dokumen_id = '" . $data['pekerjaan_dokumen_id_temp'] . "'");
  ...
  public function deleteDisposisi($where = null){
    ...
    if(isset($where['is_cc'])) $this->db->where('is_cc', $where['is_cc']);
  ...
  public function deletePekerjaanDisposisi($id, $nik = null, $id_tanggung_jawab = null, $status = null, $is_cc = null)
  {
    ...
    if (isset($is_cc)) $this->db->where('is_cc', $is_cc);
  ...
  public function getUserList($data = null)
  {
    ...
    $this->db->where('pegawai_direct_superior', $data['pegawai_poscode']);
  ...
  public function getAsetDocumentUpload($data = null)
  {
    ...
    // $this->db->select("a.*,b.*,c.*,d.*,e.*,f.*,h.pegawai_nama,case
    ...
    $this->db->join('global.global_bagian e', 'e.bagian_id=id_bagian', 'left');
    $this->db->join('global.global_pegawai f', 'f.pegawai_nik = d.id_pegawai', 'left');
    // $this->db->join('global.global_pegawai h', 'a.pekerjaan_dokumen_cc = h.pegawai_nik', 'left');
  ...
  {
    $this->db->select('b.id_user,pegawai_nama,pekerjaan_id,pegawai_postitle,pegawai_nama_dep');
    $this->db->from('dec.dec_pekerjaan a');
    $this->db->join('dec.dec_pekerjaan_disposisi b', 'a.pekerjaan_id = b.id_pekerjaan', 'left');
    $this->db->join('global.global_pegawai c', 'c.pegawai_nik = b.id_user', 'left');
    ...
    // if (isset($data['id_tanggung_jawab'])) $this->db->where('b.id_penanggung_jawab', $data['id_tanggung_jawab']);
    $this->db->where('b.is_aktif', 'y');
    $this->db->group_by('pegawai_nama,a.pekerjaan_id,c.pegawai_nik,b.id_user');
    $sql = $this->db->get();
  ...
  {
    $this->db->query("INSERT INTO dec.dec_pekerjaan_dokumen SELECT '" . $param['pekerjaan_dokumen_id'] . "',id_pekerjaan,pekerjaan_dokumen_file,id_pekerjaan_disposisi,pekerjaan_dokumen_nama,pekerjaan_dokumen_awal,'" . $param['pekerjaan_dokumen_status'] . "',pekerjaan_dokumen_keterangan,who_create,is_lama,id_pekerjaan_template,pekerjaan_dokumen_revisi,pekerjaan_dokumen_status_review,id_create,is_hps,null,id_create_awal,pekerjaan_dokumen_nomor,pekerjaan_dokumen_cc,is_review
      ,pekerjaan_dokumen_jumlah,pekerjaan_dokumen_jenis,id_bidang,id_urutan_proyek,id_section_area,pekerjaan_dokumen_waktu FROM dec.dec_pekerjaan_dokumen WHERE pekerjaan_dokumen_id = '" . $where['pekerjaan_dokumen_id'] . "'");
