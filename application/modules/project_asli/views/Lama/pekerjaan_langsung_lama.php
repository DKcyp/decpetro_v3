                    ...
                    <form id="form_modal" enctype="multipart/form-data">
                        ...
                        <div class="card-body row">
                            <div class="form-group row col-md-12">
                                ...
                                <input type="date" name="pekerjaan_waktu" id="pekerjaan_waktu" class="form-control col-md-8" value="<?= date('Y-m-d') ?>">
                        ...
                        <div class="card-body row">
                            <div class="form-group row col-md-12">
                                ...
                                <label style="color:red;display:none" id="pekerjaan_waktu_akhir_alert">Waktu Estimasi Pekerjaan Tidak Boleh Kosong</label>
                            </div>
                        </div>
                        <div class="card-body row">
                            <div class="form-group row col-md-12">
                    ...
                    <form id="form_modal_edit" enctype="multipart/form-data">
                        ...
                        <div class="card-body row">
                            <div class="form-group row col-md-12">
                                ...
                                <input type="date" name="pekerjaan_waktu_edit" id="pekerjaan_waktu_edit" class="form-control col-md-8" value="<?= date('Y-m-d') ?>">
                                <label style="color:red;display:none" id="pekerjaan_waktu_alert">Waktu Pekerjaan Tidak Boleh Kosong</label>
                            </div>
                        </div>
                        <div class="card-body row">
                    ...
                    <form id="form_modal_aksi" enctype="multipart/form-data">
                        ...
                        <div class="card-body row">
                            <div class="form-group row col-md-12">
                                ...
                                <!-- <label style="color:red;" id="pekerjaan_durasi_aksi_alert">Durasi Pekerjaan Tidak Boleh Kosong</label> -->
                            </div>
                        </div>
                        <div class="card-body row">
                            <div class="form-group row col-md-12">
                        ...
                        <div class="card-body row">
                            <div class="form-group row col-md-12">
                                ...
                                <select type="text" name="cc_id[]" id="cc_id" class="form-control col-md-8" style="width: 100%" multiple></select>
                            </div>
                        </div>
                        <div class="card-body row">
                            <div class="form-group row col-md-12">
                                <label class="col-md-4">CC HPS</label>
                                <select type="text" name="cc_hps_id[]" id="cc_hps_id" class="form-control col-md-8" style="width: 100%" multiple></select>
                            </div>
                        </div>
                        <div class="card-body row">
                            <div class="form-group row col-md-12">
                ...
                $('#table').DataTable({
                    ...
                    },
                    {
                        "render": function(data, type, full, meta) {
                            ...
                            else if (full.pekerjaan_status == '12') return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="IFC" onclick="fun_detail_modal(this.id,this.name)"><i class="fa fa-thumbs-up" data-toggle="modal" data-bs-target="#modal"></i></a></center>';
                    ...
                    {
                        "render": function(data, type, full, meta) {
                            return ((full.pekerjaan_status == '0' || full.pekerjaan_status == '-')) ? '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" title="Edit" onclick="fun_edit(this.id)"><i class="fas fa-edit" data-toggle="modal" data-target="#modal"></i></a></center>' : '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" title="Edit" onclick="fun_edit_pekerjaan(this.id)"><i class="fa fa-wrench" data-toggle="modal" data-target="#modal_pekerjaan"></i></a></center>';
                        }
                    },
                    {
                        "render": function(data, type, full, meta) {
...
function fun_tambah() {
    ...
    setTimeout(function() {
        fun_dg_document($('#pekerjaan_id').val());
    }, 500);
}
        /* Klik Tambah */
...
function fun_edit(id) {
    ...
    $.getJSON('<?= base_url() ?>project/pekerjaan_langsung/getPekerjaanLangsung?pekerjaan_id=' + id, function(json) {
        ...
        $.getJSON('project/RKAP/getUserListRevApp2', {
...
function fun_edit_pekerjaan(id) {
    ...
    $.getJSON('<?= base_url() ?>project/pekerjaan_langsung/getPekerjaanLangsung?pekerjaan_id=' + id, function(json) {
        ...
        $('#pekerjaan_waktu_edit').val(json.pekerjaan_waktunya);
...
function fun_detail(id, val) {
    // call_ajax_page('project/pekerjaan_langsung/detailPekerjaan?aksi=langsung&pekerjaan_id=' + id + '&status=' + val + '&rkap=0&id_user=');

    var url = '<?=base_url('project/pekerjaan_langsung/detailPekerjaan?aksi=langsung')?>' + '&pekerjaan_id=' + id + '&status=' + val + '&rkap=0&id_user=';
...
$('#cc_id').select2({
    dropdownParent: $('#form_modal_aksi'),
    placeholder: 'Pilih',
    ajax: {
        delay: 250,
...
function funChangePIC(val) {
    $.getJSON('project/RKAP/getUserListRevApp3', {
        pegawai_nik: val
...
function fun_detail_modal(id, val) {
    ...
    $.getJSON('<?= base_url('project/pekerjaan_langsung/getPekerjaanLangsung') ?>', {
        ...
        $('#pekerjaan_durasi_aksi').val(json.pekerjaan_akhirnya);
    ...
    $.getJSON('<?= base_url('project/pekerjaan_usulan/getUserStafVP') ?>', {
        ...
        $.each(json, function(index, val) {
            $('#' + index).val(val);
            $('#cc_id').append('<option selected value="' + val.id_user + '">' + val.pegawai_nama + '</option>');
        });
    });
    ...
    $.getJSON('<?= base_url('project/pekerjaan_usulan/getUserStafVP') ?>', {
        ...
        $.each(json, function(index, val) {
            $('#' + index).val(val);
            $('#cc_hps_id').append('<option selected value="' + val.id_user + '">' + val.pegawai_nama + '</option>');
        });
    });
