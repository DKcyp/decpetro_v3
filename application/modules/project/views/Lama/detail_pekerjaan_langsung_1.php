...
<div class="page-content">
  ...
  right connector from last child*/
    ...
    $sql_pekerjaan = $this->db->query("SELECT * FROM dec.dec_pekerjaan a LEFT JOIN global.global_pegawai b ON a.pic = b.pegawai_nik WHERE pekerjaan_id = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "'");
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row task-dates">
                            ...
                            ?>
                            <!-- Usulan -->
                            <div id="btn_approve" class="col-sm-2 col-2" style="display: none;">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-primary" onclick="fun_approve('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>', 'Apakah Anda Yakin Approved?')">Approve</button>
                                </div>
                            </div>
                            <div id="btn_reviewed" class="col-sm-2 col-2" style="display: none;">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-primary" onclick="fun_review('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>', 'Apakah Anda Yakin Reviewed?')">Reviewed</button>
                                </div>
                            </div>
                            <div id="btn_disposisi_vp" class="col-sm-2 col-2" style="display: none;">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-primary" onclick="fun_disposisi_vp()">Disposisi ke AVP</button>
                                </div>
                            </div>
                            <div id="btn_disposisi_avp" class="col-sm-2 col-2" style="display: none;">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-primary" onclick="fun_disposisi_avp('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>');fun_disposisi_avp_check_tj('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')">Reviewed AVP</button>
                                </div>
                            </div>
                            <div id="btn_reject" class="col-sm-2 col-2" style="display: none;">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-danger" onclick="fun_reject('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')">Reject</button>
                                </div>
                            </div>
                            <div id="btn_reject_avp" class="col-sm-2 col-2" style="display: none;">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-danger" onclick="fun_reject_avp('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')">Reject AVP</button>
                                </div>
                            </div>
                            <!-- Usulan -->
                            ...
                            ?>
                            <!-- Berjalan -->
                            <div class="col-sm-2 col-2 col-md-2" id="btn_upload_hps" style="display:none;margin-right:-50px">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-success" onclick="fun_upload_hps('<?= $this->input->get('pekerjaan_id') ?>','<?= $_GET['status'] ?>')">Upload HPS</button>
                                </div>
                            </div>
                            <div class="col-sm-2 col-2 col-md-2" id="btn_upload" style="display: none;margin-right:-50px">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-success" onclick="fun_upload('<?= $this->input->get('pekerjaan_id') ?>','<?= $_GET['status'] ?>')">Upload Data</button>
                                </div>
                            </div>
                            <div class="col-sm-2 col-2 col-md-2" id="btn_progress" style="display: none;margin-right:-50px">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-success" onclick="fun_progress('<?= $this->input->get('pekerjaan_id') ?>')">Progress</button>
                                </div>
                            </div>
                            <div id="btn_reject_staf" class="col-sm-2 col-2 col-md-2" style="display: none;margin-right:-50px">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-danger" onclick="fun_reject_staf('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')">Reject Staf</button>
                                </div>
                            </div>
                            <!-- Berjalan -->
                            ...
                            ?>
                            <!-- IFC -->
                            <div class="col-sm-2 col-2 col-md-2" id="btn_upload_ifc" style="display: none;">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-success" onclick="fun_upload_ifc('<?= $this->input->get('pekerjaan_id') ?>','<?= $_GET['status'] ?>')">Upload Data</button>
                                </div>
                            </div>
                            <div class="col-sm-2 col-2 col-md-2" id="btn_progress" style="display: none;">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-success" onclick="fun_progress_ifc('<?= $this->input->get('pekerjaan_id') ?>')">Progress</button>
                                </div>
                            </div>
                            <div id="btn_reject_staf" class="col-sm-2 col-2 col-md-2" style="display: none;">
                                <div class="mt-4">
                                    <button type="button" class="btn btn-danger" onclick="fun_reject_staf_ifc('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')">Reject Staf</button>
                                </div>
                            </div>
                            <!-- IFC -->
                            <?php //endif 
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-nowrap align-middle mb-0" id="table_dokumen" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama File</th>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-nowrap align-middle mb-0" id="table_dokumen_ifa" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama File</th>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Tombol -->
                        <h4 class="card-title mb-4">Dokumen</h4>
                        <table class="table table-striped table-nowrap align-middle mb-0" id="table_dokumen_ifc" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama File</th>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">Dokumen</h4>
                        <!-- <div id="div_dokumen_send_vp" style="display:none"> -->
                        <table class="table table-striped table-nowrap align-middle mb-0" id="table_dokumen_selesai" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama File</th>
                                                                ...
                                                                <?php foreach ($data1 as $value1) : ?>
                                                                    <li style="width: <?= $total1; ?>%">
                                                                        ...
                                                                        <?php if (isset($dataJumlah[1]['pekerjaan_disposisi_status'])) : ?>
                                                                            <?php
                                                                            $sql_2 = ($dataJumlah[1]['pekerjaan_disposisi_status'] <= 3) ? $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[1]['pekerjaan_disposisi_status'] . "'") : $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[1]['pekerjaan_disposisi_status'] . "' AND b.pegawai_direct_superior = '" . $value1['pegawai_poscode'] . "'");
                                                                            ...
                                                                            <?php if (isset($data2)) : ?>
                                                                                <ul>
                                                                                    <?php if ($value1['id_penanggung_jawab'] == 'y') : ?>
                                                                                        <?php foreach ($data_cc as $value_cc) : ?>

                                                                                            <!-- <li style="width: 100%"> -->
                                                                                            <a href="javascript:0;"><?= ($value_cc['id_penanggung_jawab'] == 'y') ? '<b><u>' . $value_cc['pegawai_nama'] . '</u></b>' : '<i>' . $value_cc['pegawai_nama'] . '</i>' ?></a>
                                                                                            <!-- </li> -->
                                                                                        <?php endforeach ?>
                                                                                    <?php endif ?>
                                                                                    <?php foreach ($data2 as $value2) : ?>
                                                                                        <li style="width: <?= $total2; ?>%">
                                                                                            ...
                                                                                            <?php if (isset($dataJumlah[2]['pekerjaan_disposisi_status'])) : ?>
                                                                                                <?php
                                                                                                $sql_3 = ($dataJumlah[2]['pekerjaan_disposisi_status'] <= 3) ? $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[2]['pekerjaan_disposisi_status'] . "'") : $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[2]['pekerjaan_disposisi_status'] . "' AND b.pegawai_direct_superior = '" . $value2['pegawai_poscode'] . "'");
                                                                                                ...
                                                                                                <?php if (isset($data3)) : ?>
                                                                                                    <ul>
                                                                                                        <?php if ($value2['id_penanggung_jawab'] == 'y') : ?>
                                                                                                            <?php foreach ($data_cc as $value_cc) : ?>
                                                                                                        ...
                                                                                                        <?php foreach ($data3 as $value3) : ?>
                                                                                                            <li style="width: <?= $total3; ?>%">
                                                                                                                ...
                                                                                                                <?php if (isset($dataJumlah[3]['pekerjaan_disposisi_status'])) : ?>
                                                                                                                    <?php
                                                                                                                    $sql_4 = ($dataJumlah[3]['pekerjaan_disposisi_status'] <= 3) ? $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik 
                                                          LEFT JOIN global.global_bagian_detail c ON c.id_pegawai = a.id_user LEFT JOIN global.global_bagian d ON d.bagian_id = c.id_bagian WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[3]['pekerjaan_disposisi_status'] . "'") : $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik 
                                                          LEFT JOIN global.global_bagian_detail c ON c.id_pegawai = a.id_user LEFT JOIN global.global_bagian d ON d.bagian_id = c.id_bagian WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[3]['pekerjaan_disposisi_status'] . "' AND b.pegawai_direct_superior = '" . $value3['pegawai_poscode'] . "'");
                                                                                                                    ...
                                                                                                                    <?php if (isset($data4)) : ?>
                                                                                                                        <ul>
                                                                                                                            <?php if ($value3['id_penanggung_jawab'] == 'y') : ?>
                                                                                                                                <?php foreach ($data_cc as $value_cc) : ?>
                                                                                                                                    ...
                                                                                                                                    <?php if (isset($dataJumlah[4]['pekerjaan_disposisi_status'])) : ?>
                                                                                                                                        ...
                                                                                                                                        <?php if (isset($data5)) : ?>
                                                                                                                                            <ul>
                                                                                                                                                ...
                                                                                                                                                <?php if ($value4['id_penanggung_jawab'] == 'y') : ?>
                                                                                                                                                    <?php foreach ($data_cc as $value_cc) : ?>
                    ...
                    <form id="form_modal_avp">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group row col-md-12" id="div_pekerjaan_waktu_akhir_avp" style="display:none">
                                ...
                                <input type="date" name="pekerjaan_waktu_akhir_avp" id="pekerjaan_waktu_akhir_avp" class="form-control col-md-8">
                            </div>
                            ...
                            <div class="form-group row col-md-12" id="div_id_user_avp" style="display:none">
                                ...
                                <select name="id_user_avp" id="id_user_avp" class="form-control col-md-8 select2" style="width: 100%" onchange="cekAVPDispoSama(this.value)"></select>
                            </div>
                            <div class="form-group row col-md-12" id="div_id_user_avp_listrik" style="display:none">
                                ...
                                <select name="id_user_avp_listrik" id="id_user_avp_listrik" class="form-control col-md-8 select2" style="width: 100%" onchange="cekAVPDispoSama(this.value)"></select>
                            </div>
                            <div class="form-group row col-md-12" id="div_id_user_avp_instrumen" style="display:none">
                                ...
                                <select name="id_user_avp_instrumen" id="id_user_avp_instrumen" class="form-control col-md-8 select2" style="width: 100%" onchange="cekAVPDispoSama(this.value)"></select>
                            </div>
                        </div>
                        <div class="modal-footer justify-content-between">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" aria-label="Close" onclick="return fun_cancel_dokumen()"></button>
                </div>
                <div class="modal-body">
                    <form id="form_upload_dokumen">
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="button" id="draft_dokumen" class="btn btn-primary" onclick="fun_close_dokumen()">Draft</button>
                            ...
                            <?php //else : 
                            ?>
                            <input type="submit" class="btn btn-success pull-right" id="simpan_dokumen" value="Send IFA">
                            <?php //endif; 
                            ?>
    ...
    <div class="modal fade" id="modal_upload_hps" data-bs-backdrop="static">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Upload Document HPS</h4>
                    <button type="button" class="btn-close" aria-label="Close" onclick="return fun_cancel_dokumen_hps()"></button>
                </div>
                <div class="modal-body">
                    <form id="form_upload_dokumen_hps">
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="button" id="draft_dokumen_hps" class="btn btn-primary" onclick="fun_close_dokumen_hps()">Draft</button>
    ...
    $(function() {
        ...
        $.getJSON('<?= base_url('project/pekerjaan_langsung/getPekerjaanLangsung') ?>', {
            ...
            if ('<?= $_GET['aksi'] ?>' == 'langsung') {
                ...
                if (json.pekerjaan_status == '1') {
                ...
                } else if (json.pekerjaan_status == '6') {
                    /* Reviewed AVP Cangun */
                    ...
                    $('#btn_reject_staf').hide();
                    /* Approve VP Cangun */
                } else if (json.pekerjaan_status == '8') {
                    /* Approve PIC */
                    $('#btn_upload').css('display', 'none');
                    $('#btn_upload_hps').css('display', 'none');
                    $('#btn_progress').css('display', 'none');
                    ...
                    $('#btn_reject_staf').hide();
                    /* Approve PIC */
                } else if (json.pekerjaan_status == '9' && json.pekerjaan_disposisi_status == '9' && json.is_proses == 'y') {
                    /* Upload File Staf Cangun */
                    ...
                    $('#btn_revisi').css('display', 'none');
                    $('#btn_reject_staf').hide();
                } else if (json.pekerjaan_status == '9' && json.pekerjaan_disposisi_status == '10' && json.is_proses == 'y') {
                    /* Upload File Staf Cangun */
                    $('#btn_upload_ifc').css('display', 'none');
                    $('#btn_progress').css('display', 'none');
                    $('#btn_send_avp_ifc').hide();
                    ...
                    $('#btn_revisi').css('display', 'none');
                    $('#btn_reject_staf').hide();
                } else if (json.pekerjaan_status == '9' && json.pekerjaan_disposisi_status == '10') {
                    /* Upload File Staf Cangun */
                    $('#btn_upload_ifc').css('display', 'none');
                    $('#btn_progress').css('display', 'none');
                    ...
                    $('#btn_revisi').css('display', 'block');
                    $('#btn_reject_staf').hide();
                } else if (json.pekerjaan_status == '9') {
                    /* Upload File Staf Cangun */
                    ...
                    $('#btn_reject_staf').hide();
                    /* Upload File Staf Cangun */
                } else if (json.pekerjaan_status == '10') {
                    /* Reviewed AVP Cangun */
                    $('#btn_upload').css('display', 'none');
                    $('#btn_progress').css('display', 'none');
                ...
                },
                {
                    "render": function(data, type, full, meta) {
                        ...
                        if (full.pekerjaan_dokumen_status == '0') {
                            ...
                            var data = 'Approved AVP';
                        } else if (full.pekerjaan_dokumen_status == '4') {
                            var data = 'Approved VP';
                ...
                },
                {
                    "render": function(data, type, full, meta) {
                        ...
                        if (full.id_bagian == $('#session_bagian').val() && full.avp == 'y' && full.is_proses != 'y' && full.vp != 'y') {
                            ...
                            aksi = '<center><a href="javascript:;" id="' + full.pekerjaan_dokumen_id + '" title="Aksi" onclick="fun_aksi(this.id)"><i class="fa fa-share"></i></a></center>';
                        } else if (full.pekerjaan_dokumen_status == '0' && full.staf == 'y') {
                            aksi = '<center><a href="javascript:;" id="' + full.pekerjaan_dokumen_id + '" title="Aksi" onclick="fun_aksi_staf(this.id)"><i class="fa fa-share"></i></a></center>';
                        } else {
                            aksi = '<center> - </center>';
                        }
                        return aksi;
            ...
            "columns": [{
                ...
                },
                {
                    "render": function(data, type, full, meta) {
                        ...
                        } else if (full.is_proses == 'a' && full.vp == 'n' && full.is_hps != 'y') {
                            aksi = '<center><a href="javascript:;" id="' + full.pekerjaan_dokumen_id + '" title="Aksi" onclick="fun_aksi_ifa(this.id)"><i class="fa fa-share"></i></a></center>';
                        } else if (full.vp == 'n' && full.cc == 'y') {
                            aksi = '<center><a href="javascript:;" id="' + full.pekerjaan_dokumen_id + '" title="Aksi" onclick="fun_aksi_ifa(this.id)"><i class="fa fa-share"></i></a></center>';
        ...
        $('#table_dokumen_ifc').DataTable({
            "scrollX": true,
            "ajax": {
                "url": "<?= base_url('project/pekerjaan_usulan/') ?>getAsetDocumentIFC?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>",
                "dataSrc": ""
            },
            "columns": [{
                    render: function(data, type, full, meta) {
    ...
    function fun_upload_ifc(id, val) {
        ...
        setTimeout(function() {
            $('#dg_document_ifc').edatagrid({
                url: '<?= base_url("project/pekerjaan_usulan/getAsetDocumentIFC?pekerjaan_dokumen_status=n&id_pekerjaan=") ?>' + id + '&pekerjaan_status=' + val + '&id_create=' + $('#session_user').val(),
    ...
    function fun_approve_berjalan(id, text) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                call_ajax_page('project/pekerjaan_langsung')
                $.getJSON('<?= base_url('project/pekerjaan_langsung/prosesApproveBerjalan') ?>', {
                    pekerjaan_id: id,
                    pekerjaan_status: $('#pekerjaan_status').val(),
    ...
    function fun_approve_ifa(id, text) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                if ($('#is_rkap').val() == '1') {
                    call_ajax_page('project/RKAP#link_div_ifa');
                } else {
                    call_ajax_page('project/Non_RKAP#link_div_ifa');
                }
            ...
            $.ajax({
                ...
                success: function(isi) {
                    ...
                    if ($('#is_rkap').val() == '1') {
                        ...
                        call_ajax_page('project/Non_RKAP');
                    }
