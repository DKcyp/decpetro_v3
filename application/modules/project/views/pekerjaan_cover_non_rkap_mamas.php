    ...
    <tr>
      <td>
        <table class="table" width="100%" border="1" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td style="padding-left: 5px;">
              <span style="font-size: 10pt;">
                No. Pekerjaan : <b style="font-size: 12px;"><?= (!empty($pekerjaan)) ? $pekerjaan['pekerjaan_nomor'] : '' ?></b>
              </span>
            </td>
            <?php else: ?>
            <td style="padding-left: 5px;">
          ...
          <tr>
            <?php if ($template['pekerjaan_dokumen_kertas'] == 'A3' && $template['pekerjaan_dokumen_orientasi'] == 'Landscape'): ?>
            <td colspan="1" style="padding-left: 5px;font-size: 10pt;">No Dokumen : <?= (!empty($template)) ? $template['pekerjaan_dokumen_nomor'] : ''   ?>
            </td>
            <?php else: ?>
            ...
            <?php endif ?>
            <td style="padding-left: 5px; font-size: 9pt;" width="70px">Lembar: <b><?= (!empty($template)) ? $template['pekerjaan_dokumen_jumlah'] : '' ?></b>
            </td>
          </tr>
        </table>
      </td>
