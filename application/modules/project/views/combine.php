...
if ($kertas != '' && $orientasi != '') {
	...
	if ($status_dokumen >= '4' && $status_dokumen <= '7'  && $klasifikasi_pekerjaan_kode != 'ifi'  && $klasifikasi_pekerjaan_kode != 'ift') {
		...
		if ($kertas == 'A3' && $orientation == 'L') {
			...
			addWatermark(225, 51, $watermarkText, 0.2, $pdf, $kertas, $orientation);
		} else if ($kertas == 'A4' && $orientation == 'P') {
			addWatermark(138, 55, $watermarkText, 0.2, $pdf, $kertas, $orientation);
		}
		$pdf->SetXY(25, 25);
		...
		if ($kertas == 'A3' && $orientation == 'L') {
			addWatermark(294, 52, $watermarkText, 0.2, $pdf, $kertas, $orientation);
		} else if ($kertas == 'A3' && $orientation == 'P') {
			addWatermark(208	, 52, $watermarkText, 0.2, $pdf, $kertas, $orientation);
		} else if ($kertas == 'A4' && $orientation == 'L') {
			addWatermark(207, 51, $watermarkText, 0.2, $pdf, $kertas, $orientation);
		} else if ($kertas == 'A4' && $orientation == 'P') {
			addWatermark(121, 55, $watermarkText, 0.2, $pdf, $kertas, $orientation);
		} else {
		}
		$pdf->SetXY(25, 25);
	} else {
