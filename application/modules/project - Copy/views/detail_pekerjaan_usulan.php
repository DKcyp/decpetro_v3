          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <button type="button" class="btn btn-info col-1 float-end" onclick="funcModalSendAVPIFC(<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>)" id="btn_send_avp_ifc_koor" style="display:none">
                  Send AVP Koor
                </button>
    ...
    // })
      ...
      $.getJSON('<?= base_url('project/pekerjaan_usulan/getPekerjaan') ?>', {
        ...
        /* Berjalan */
          ...
          } else if (json.pekerjaan_status == '8' && json.id_user == '<?= $data_session['pegawai_nik'] ?>' && json.is_cc == null) {
          /* Approve PIC */
            $('#btn_upload').css('display', 'none');
            $('#btn_upload_hps').css('display', 'none');
            $('#btn_progress').css('display', 'none');
          ...
          /* Upload File Staf Cangun */
            ...
            $('#btn_ganti_perencana').hide();
          /* Upload File Staf Cangun */
          } else if (json.pekerjaan_status == '10' && json.is_proses == 'y') {
          /* Reviewed AVP Cangun */
            $('#btn_upload').css('display', 'none');
            $('#btn_progress').css('display', 'none');
            $('#btn_send_ifa').css('display', 'none');
            ...
            $('#btn_ganti_perencana').hide();
          /* Reviewed AVP Cangun */
          } else if (json.pekerjaan_status == '10' && json.id_penanggung_jawab == 'y') {
          /* Reviewed AVP Cangun */
            $('#btn_upload').css('display', 'none');
            $('#btn_progress').css('display', 'none');
            $('#btn_send_ifa').css('display', 'none');
            ...
            $('#btn_ganti_perencana').hide();
          /* Reviewed AVP Cangun */
          } else if (json.pekerjaan_status == '10' && json.id_penanggung_jawab == 'n') {
          /* Reviewed AVP Cangun */
            $('#btn_upload').css('display', 'none');
            $('#btn_progress').css('display', 'none');
            $('#btn_send_ifa').css('display', 'none');
...
function fun_approve_ifa(id, text) {
    // $.getJSON('<?= base_url('project/pekerjaan_usulan/getStatusIFA') ?>', {
    //   pekerjaan_id: $('#id_pekerjaan_send_vp').val()
    // }, function(json) {
    //   if (json.total > 0) {
    //     Swal.fire(
    //       'Peringatan!',
    //       'Masih Ada ' + json.total + ' Dokumen Yang Belum Siap!',
    //       'warning'
    //       );
    //   } else {
  Swal.fire({
...
$('#form_modal_send_vp').on('submit', function(e) {
  e.preventDefault();
    // $.getJSON('<?= base_url('project/pekerjaan_usulan/getStatus') ?>', {
    //   pekerjaan_id: $('#id_pekerjaan_send_vp').val()
    // }, function(json) {
    //   if (json.total > 0) {
    //     Swal.fire(
