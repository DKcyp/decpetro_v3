...
<div class="page-content">
    ...
    <!-- SQL Klasifikasi -->
    <?php $klasifikasi = $this->db->query("SELECT * FROM global.global_klasifikasi_pekerjaan a WHERE klasifikasi_pekerjaan_id = '1' ")->row_array(); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            ...
                            <input type="text" hidden name="session_direct_superior" id="session_direct_superior" value="<?= $data_session['pegawai_direct_superior'] ?>">
                            <input type="text" hidden name="session_poscode" id="session_poscode" value="<?= $data_session['pegawai_poscode'] ?>">
                            <input type="text" name="session_nik" id="session_nik" value="<?= $data_session['pegawai_nik'] ?>" hidden>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="javascript:;" onclick="div_usulan()" id="link_div_usulan">Usulan <input hidden type="text" id="notif_usulan_reject_rkap"><span class="badge bg-primary fload_end" id="notif_usulan_rkap"></span></a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:;" onclick="div_berjalan()" id="link_div_berjalan">Berjalan <span class="badge bg-secondary fload_end" id="notif_pekerjaan_rkap"></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="javascript:;" onclick="div_ifa()" id="link_div_ifa">IFA <span class="badge bg-success fload_end" id="notif_ifa_rkap"></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="javascript:;" onclick="div_ifc()" id="link_div_ifc">IFC <span class="badge bg-warning fload_end" id="notif_ifc_rkap"></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="javascript:;" onclick="div_selesai()" id="link_div_selesai">Selesai <span class="badge bg-dark fload_end" id="notif_selesai_rkap"></a>
                                            </li>
                                        </ul>
                    ...
                    <!-- MODAL -->
                    <!-- start modal usulan -->
                    <div class="modal fade" id="modal_usulan" data-bs-backdrop="static">
        ...
        $(function() {
            ...
            if ($('#pegawai_jabatan').val() == '2') {
              ...
              if ($('#jabatan_atasan').val() == '2') {
                ...
                var newOption = new Option($('#nama_atasan').val()+' - '+$('#postitle_atasan').val(), $('#nik_atasan').val(), true, true);
                $('#reviewer').append(newOption).trigger('change');
                $.getJSON('project/RKAP/getUserListRevApp2', {param1: $('#direct_superior_atasan').val()}, function(json) {
            ...
            },
            {
                "render": function(data, type, full, meta) {
                    if (full.pekerjaan_status == '0') return '<center>-</center>';
                            // jika staf
                            // else if (($('#session_poscode').val() == 'E53110041A' || $('#session_poscode').val() == 'E53210051A' || $('#session_poscode').val() == 'E53310041A' || $('#session_poscode').val() == 'E53410041A' || $('#session_poscode').val() == 'E53410041B' || $('#session_poscode').val() == 'E53410051A' || $('#session_poscode').val() == 'E53500031B' || $('#session_poscode').val() == 'E53600031A' || $('#session_poscode').val() == 'E53600060B')) return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Detail" onclick="fun_detail(this.id,this.name)"><i style="; color:white" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_usulan">Detail</i></a></center>';
                        ...
                        return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Review" onclick="fun_detail(this.id,this.name)"><i  color:white" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal_usulan">Detail</i></a></center>';
                    else if (full.pekerjaan_status == '1' && $('#session_direct_superior').val() == 'E31000000')
                        return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Review" onclick="fun_detail(this.id,this.name)"><i style="background-color:orange; color:white" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal_usulan">Review</i></a></center>';
                        ...
                        return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Review" onclick="fun_detail(this.id,this.name)"><i style="background-color:red; color:white" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal_usulan">Approve</i></a></center>';
                            // FINISH BUTTON PEKERJAAN STATUS 2



                            // else if (full.pekerjaan_status == '1' && ($('#session_poscode').val() != 'E53110041A' || $('#session_poscode').val() != 'E53210051A' || $('#session_poscode').val() != 'E53310041A' || $('#session_poscode').val() != 'E53410041A' || $('#session_poscode').val() != 'E53410041B' || $('#session_poscode').val() != 'E53410051A' || $('#session_poscode').val() != 'E53500031B' || $('#session_poscode').val() != 'E53600031A' || $('#session_poscode').val() != 'E53600060B')) return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Review" onclick="fun_detail(this.id,this.name)"><i style="background-color:orange; color:white" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal_usulan">Review</i></a></center>';
                            // pekerjaan 2
                            // else if (full.pekerjaan_status == '2' && ($('#session_poscode').val() == 'E53000000')) return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Approve" onclick="fun_detail(this.id,this.name)"><i style="background-color:orange;color:white" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal_usulan">Approve</i></a></center>';
                            // else if (full.pekerjaan_status == '2') return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Approve" onclick="fun_detail(this.id,this.name)"><i class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_usulan">Detail</i></a></center>';
                            // pekerjaan 3
                    else if (full.pekerjaan_status == '3' && $('#session_direct_superior').val() == 'E53000000') return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Approve" onclick="fun_detail(this.id,this.name)"><i style="background-color:red; color:white" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal_usulan">Approve</i></a></center>';
                            // pekerjaan 4
                        ...
                        return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Review" onclick="fun_detail(this.id,this.name)"><i style="background-color:orange; color:white" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal_usulan">Review</i></a></center>';
                            ...
                            // else if (full.pekerjaan_status == '4' && ($('#session_poscode').val() == 'E53100000' || $('#session_poscode').val() == 'E53200000' || $('#session_poscode').val() == 'E53300000' || $('#session_poscode').val() == 'E53400000')) return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Approve" onclick="fun_detail(this.id,this.name)"><i class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal_usulan">Review</i></a></center>';
                            // else if (full.pekerjaan_status == '4' && ($('#session_poscode').val() == 'E53000000')) return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Approve" onclick="fun_detail(this.id,this.name)"><i  class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_usulan">Detail</i></a></center>';
                            // selain
                    else return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Detail" onclick="fun_detail(this.id,this.name)"><i class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_usulan">Detail</i></a></center>';
                }
            },
            {
                "render": function(data, type, full, meta) {
                    return ((full.pekerjaan_status == '0' || full.pekerjaan_status == '-') && full.pic == $('#session_nik').val()) ? '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" title="Edit" onclick="fun_edit(this.id)"><i class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal_usulan">Edit</i></a></center>' : '<center>-</center>';
                }
            },
            {
                "render": function(data, type, full, meta) {
...
$('#table_berjalan').DataTable({
    ...
    {
        "render": function(data, type, full, meta) {
            return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Detail" onclick="fun_detail(this.id,this.name)"><i class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_usulan">Detail</i></a></center>';
        }
    },
    {
        render: function(data, type, full, meta) {
...
var table_ifa = $('#table_ifa').DataTable({
    ...
    "scrollX": true,
    "ajax": {
        "url": "<?= base_url('project/') ?>pekerjaan_usulan/getPekerjaanUsulan?klasifikasi_pekerjaan_id=1&pekerjaan_status=8",
        "dataSrc": ""
    },
    "columns": [{
        render: function(data, type, full, meta) {
    ...
    {
        "render": function(data, type, full, meta) {
            return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Detail" onclick="fun_detail_disposisi(this.id,this.name)"><i class="btn btn-info btn-sm">Detail</i></a></center>';
        }
    },
    {
        "render": function(data, type, full, meta) {
    ...
    {
        "render": function(data, type, full, meta) {
            if ($('#user_session').val() == '2190626' && (full.extend_status != '1')) return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Extend" onclick="fun_extend(this.id,this.name)"><i class="fas fa-share" data-toggle="modal" data-target="#modal_extend"></i></a></center>';
...
$('#table_ifc').DataTable({
    ...
    initComplete: function() {
        ...
        .each(function(colIdx) {
            ...
            .on('keyup change', function(e) {
                ...
                // "scrollX": true,
    "ajax": {
        "url": "<?= base_url() ?>project/pekerjaan_usulan/getPekerjaanUsulan?klasifikasi_pekerjaan_id=1&pekerjaan_status=9,10,11",
        "dataSrc": ""
    },
    "columns": [{
        render: function(data, type, full, meta) {
    ...
    },
    {
        "render": function(data, type, full, meta) {
            ...
            if (full.pekerjaan_status == 0) {
                ...
                warna = '#00FF00';
                status = 'AMenunggu Approval VP Rancang Bangun'
            } else if (full.pekerjaan_status == 4) {
                warna = '#0080FF';
                status = 'Approved VP Cangun'
            } else if (full.pekerjaan_status == 5) {
                ...
                warna = '#FF8000';
                status = 'IFA'
            } else if (full.pekerjaan_status == 9 && (full.is_proses == 'y' || full.is_proses == null)) {
                warna = '#B266FF';
                status = 'IFC';
            } else if (full.pekerjaan_status == 9 && full.is_proses == 'n') {
                warna = '#B266FF';
                status = 'IFA';
            } else if (full.pekerjaan_status == 10 && full.is_proses == 'y') {
                warna = '#B266FF';
                status = 'IFC';
            } else if (full.pekerjaan_status == 10 && full.is_proses == 'n') {
                warna = '#B266FF';
                status = 'IFA';
            } else if (full.pekerjaan_status == 11 && full.is_proses == 'y') {
                warna = '#B266FF';
                status = 'IFC';
            } else if (full.pekerjaan_status == 11 && full.is_proses == 'n') {
                warna = '#B266FF';
                status = 'IFA';
            } else if (full.pekerjaan_status == 10) {
                warna = '#B266FF';
    ...
    {
        "render": function(data, type, full, meta) {
            return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Detail" onclick="fun_detail(this.id,this.name)"><i class="btn btn-info btn-sm">Detail</i></a></center>';
        }
    },
...
$('#table_selesai').DataTable({
    ...
    initComplete: function() {
        ...
        api.columns().eq(0).each(function(colIdx) {
            ...
            $('input', $('.filters_selesai th').eq($(api.column(colIdx).header()).index())).off('keyup change').on('keyup change', function(e) {
                ...
                // "scrollX": true,
    "ajax": {
        "url": "<?= base_url() ?>project/pekerjaan_usulan/getPekerjaanUsulan?klasifikasi_pekerjaan_id=1&pekerjaan_status=12,15,16",
        "dataSrc": ""
    },
    "columns": [{
        render: function(data, type, full, meta) {
    ...
    {
        "render": function(data, type, full, meta) {
            return (full.is_allow == 'y') ? '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Detail" onclick="fun_detail(this.id,this.name)"><i class="btn btn-info btn-sm">Detail</i></a></center>' : '-';
        }
    },
    ]
}).columns.adjust();
...
function fun_edit(id) {
    ...
    $.getJSON('<?= base_url() ?>project/pekerjaan_usulan/getPekerjaanUsulan?pekerjaan_id=' + id, function(json) {
        ...
        $('#pekerjaan_tahun').val(json.pekerjaan_tahun);
                ...
                /*SELECTED SELECT2*/
        $.getJSON('project/RKAP/getUserListRevApp2', {pegawai_nik: json.pekerjaan_reviewer}, function(jsonReviewer) {
          var newOption = new Option(jsonReviewer.text, jsonReviewer.id, true, true);
          $('#reviewer').append(newOption).trigger('change');
      });

        $.getJSON('project/RKAP/getUserListRevApp2', {pegawai_nik: json.pekerjaan_approver}, function(jsonApprover) {
...
function fun_detail(id, val) {
    ...
    var url = '<?=base_url('project/pekerjaan_usulan/detailPekerjaan?aksi=')?>'+ $('#pekerjaan_status_nama').val() + '&pekerjaan_id=' + id + '&status=' + val + '&rkap=1';
...
{
    $('#table_usulan').DataTable().ajax.reload(null,false);
    $('#table_berjalan').DataTable().ajax.reload(null,false);
    $('#table_ifa').DataTable().ajax.reload(null,false);
    $('#table_ifc').DataTable().ajax.reload(null,false);
    $('#table_selesai').DataTable().ajax.reload(null,false);
}
