...
class Pekerjaan_usulan extends MX_Controller
{
  ...
  {
    $isi = (isset($_GET['id_user'])) ? $this->db->get_where('global.global_pegawai', array('pegawai_nik' => $_GET['id_user']))->row_array() : $this->session->userdata();
    $pekerjaan_status = '0';
  ...
  public function prosesSendVP()
  {
    ...
    // cek apakah koordinator atau bukan
        ...
        if ($pekerjaan_id) {
          if ($data_koordinator['total'] > '0') {
            ...
            $data_disposisi['pekerjaan_disposisi_status'] = anti_inject($pekerjaan_status);
            $this->M_pekerjaan->insertPekerjaanDisposisi($data_disposisi);
            dblog('I',  $pekerjaan_id, 'Pekerjaan Telah di Review IFA AVP Koordinator', $isi['pegawai_nik']);
          } else {
            dblog('I',  $pekerjaan_id, 'Pekerjaan Telah di Review IFA AVP Terkait', $isi['pegawai_nik']);
          }
        }
        /* Pekerjaan */
    ...
    // ubah status dokumen ke IFC
        ...
        foreach ($data_dokumen_send as $val_dokumen) {
          $dokumen_ada = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan = '" . $this->input->get_post('pekerjaan_id') . "' AND pekerjaan_dokumen_status = '3' AND pekerjaan_dokumen_nama = '" . $val_dokumen['pekerjaan_dokumen_nama'] . "' AND id_pekerjaan_template = '" . $val_dokumen['id_pekerjaan_template'] . "' AND is_hps = 'n'")->row_array();
          if (!empty($dokumen_ada) && ($dokumen_ada['pekerjaan_dokumen_nama'] == $val_dokumen['pekerjaan_dokumen_nama'] && $dokumen_ada['id_pekerjaan_template'] == $val_dokumen['id_pekerjaan_template'])) {
        // skip
          } else {
        ...
        foreach ($data_dokumen_send_hps as $val_dokumen) {
          $dokumen_ada = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan = '" . $this->input->get_post('pekerjaan_id') . "' AND pekerjaan_dokumen_status ='3' AND pekerjaan_dokumen_nama = '" . $val_dokumen['pekerjaan_dokumen_nama'] . "' AND id_pekerjaan_template = '" . $val_dokumen['id_pekerjaan_template'] . "' AND is_hps = 'y'")->row_array();
          if (!empty($dokumen_ada) && ($dokumen_ada['pekerjaan_dokumen_nama'] == $val_dokumen['pekerjaan_dokumen_nama'] && $dokumen_ada['id_pekerjaan_template'] == $val_dokumen['id_pekerjaan_template'])) {
        // skip
          } else {
            $data['pekerjaan_dokumen_id_temp'] = anti_inject($val_dokumen['pekerjaan_dokumen_id']);
    ...
    // $this->db->query("UPDATE dec.dec_pekerjaan_dokumen SET pekerjaan_dokumen_status = '5' WHERE id_pekerjaan = '" . $pekerjaan_id . "' AND id_create_awal = '" . $isi['pegawai_nik'] . "' AND pekerjaan_dokumen_status = '4' AND (is_lama !='y' OR is_lama is null) AND pekerjaan_dokumen_awal != 'y' AND is_hps = 'y'");
    ...
    // update dokumen dengan bagian yang sesuai
    ...
    //  CC HPS
            ...
            $param_staf['is_proses'] = 'y';
            $this->M_pekerjaan->updateStatusProses($where_id_user, $where_id_pekerjaan, $where_disposisi_status, $param_staf);
            dblog('I',  $pekerjaan_id, 'Pekerjaan Telah di Review Oleh Cangun', $isi['pegawai_nik']);
    ...
    // die();
      ...
      // echo $this->db->last_query();
                ...
                dblog('I',  $pekerjaan_id, 'Pekerjaan Telah di Review IFC AVP Terkait', $session['pegawai_nik']);
              }
    ...
    // cek apakah koordinator atau bukan
                    ...
                    if ($pekerjaan_id) {
                      if ($data_koordinator['total'] > '0') {
                        $data['pekerjaan_status'] = anti_inject($pekerjaan_status);
                        $this->M_pekerjaan->updatePekerjaan($data, $pekerjaan_id);
                        dblog('I',  $pekerjaan_id, 'Pekerjaan Telah di Review IFC AVP Koordinator', $isi['pegawai_nik']);
    ...
    // UPDATE DOKUMEN
                    ...
                    $data_dokumen = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan = '" . $pekerjaan_id . "' AND is_lama = 'n' AND pekerjaan_dokumen_status >= '6' AND pekerjaan_dokumen_status <= '7' AND is_hps='n' AND id_create_awal IN (SELECT id_pegawai FROM global.global_bagian_detail WHERE id_bagian = '" . $data_bagian['id_bagian'] . "')  ")->result_array();
    ...
    // print_r($data_pekerjaan);
                        if ($pekerjaan_id) {
                          ...
                          } else if($this->input->get_post('pekerjaan_status')=='11') {
                            $data['pekerjaan_status'] = anti_inject($pekerjaan_status);
                            $data['pekerjaan_waktu_selesai'] = date('Y-m-d H:i:s');
                            $this->M_pekerjaan->updatePekerjaan($data, $pekerjaan_id);
                          }else{
                        ...
                        if ($pekerjaan_status == '7') {
                          dblog('I',  $pekerjaan_id, 'Pekerjaan Telah di Approve IFA VP Rancang Bangun', $isi['pegawai_nik']);
                        } else {
                          dblog('I',  $pekerjaan_id, 'Pekerjaan Telah di Approve IFC VP Rancang Bangun', $isi['pegawai_nik']);
                        }
                        /* Pekerjaan */
    ...
    // print_r($this->db->last_query());
                        ...
                        /* Disposisi */
                        if ($this->input->get_post('pekerjaan_status') != '11') {
                          $data_disposisi['pekerjaan_disposisi_id'] = create_id();
                          $data_disposisi['pekerjaan_disposisi_waktu'] = date("Y-m-d H:i:s");
                          $data_disposisi['id_user'] = ($pekerjaan_status == '8') ? $isi_pekerjaan['pic'] : $user['pegawai_nik'];
                          $data_disposisi['id_pekerjaan'] = anti_inject($pekerjaan_id);
    ...
    // ubah status dokumen ke IFC
                        ...
                        foreach ($data_dokumen_send as $val_dokumen) {
                          $dokumen_ada = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan = '" . $this->input->get_post('pekerjaan_id') . "' AND pekerjaan_dokumen_status ='4' AND pekerjaan_dokumen_nama = '" . $val_dokumen['pekerjaan_dokumen_nama'] . "' AND id_pekerjaan_template = '" . $val_dokumen['id_pekerjaan_template'] . "' AND is_hps = 'n'")->row_array();
                          if (!empty($dokumen_ada) && ($dokumen_ada['pekerjaan_dokumen_nama'] == $val_dokumen['pekerjaan_dokumen_nama'] && $dokumen_ada['id_pekerjaan_template'] == $val_dokumen['id_pekerjaan_template'])) {
        // skip
                          } else {
                            $data['pekerjaan_dokumen_id_temp'] = anti_inject($val_dokumen['pekerjaan_dokumen_id']);
                            ...
                            $data['is_proses'] = 'a';
                            $this->M_pekerjaan->simpanAksiSama($data);
                            $update = $this->db->query("UPDATE dec.dec_pekerjaan_dokumen SET pekerjaan_dokumen_waktu = '".date('Y-m-d H:i:s')."' WHERE pekerjaan_dokumen_id = '".$data['pekerjaan_dokumen_id']."'");
                          }
                        }
                        ...
                        foreach ($data_dokumen_send_hps as $val_dokumen) {
                          $dokumen_ada = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan = '" . $this->input->get_post('pekerjaan_id') . "' AND pekerjaan_dokumen_status ='4' AND pekerjaan_dokumen_nama = '" . $val_dokumen['pekerjaan_dokumen_nama'] . "' AND id_pekerjaan_template = '" . $val_dokumen['id_pekerjaan_template'] . "' AND is_hps = 'y'")->row_array();
                          if (!empty($dokumen_ada) && ($dokumen_ada['pekerjaan_dokumen_nama'] == $val_dokumen['pekerjaan_dokumen_nama'] && $dokumen_ada['id_pekerjaan_template'] == $val_dokumen['id_pekerjaan_template'])) {
        // skip
                          } else {
                            $data['pekerjaan_dokumen_id_temp'] = anti_inject($val_dokumen['pekerjaan_dokumen_id']);
                        ...
                        $data_dokumen_ifc = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan = '" . $pekerjaan_id . "' AND  pekerjaan_dokumen_status = '8' AND (is_lama !='y' OR is_lama is null) AND pekerjaan_dokumen_awal != 'y' AND is_hps = 'n' AND (is_update_ifa !='y' OR is_update_ifa is NULL)")->result_array();

                        if (!empty($data_dokumen_ifc)) {
                          foreach ($data_dokumen_ifc as $val_dokumen) {
                            $data['pekerjaan_dokumen_id_temp'] = anti_inject($val_dokumen['pekerjaan_dokumen_id']);
                            $data['pekerjaan_dokumen_id'] = anti_inject(create_id());
                            $data['pekerjaan_dokumen_status'] = '9';
                            $data['pekerjaan_dokumen_keterangan'] = '';
                            $data['id_create'] = $isi['pegawai_nik'];
                            $data['is_proses'] = 'a';
                            $this->M_pekerjaan->simpanAksiSama($data);
                          }
                          $this->db->query("UPDATE dec.dec_pekerjaan_dokumen SET is_lama = 'y' WHERE id_pekerjaan = '" . $pekerjaan_id . "'  AND (pekerjaan_dokumen_status = '0' OR pekerjaan_dokumen_status = '8') AND (is_lama !='y' OR is_lama is null) AND pekerjaan_dokumen_awal != 'y' AND is_hps = 'n'");
                        }
                      }
    ...
    // }
                      ...
                      public function prosesReject()
                      {
                        ...
                        if ($pekerjaan_id) {
                          ...
                          dblog('I',  $pekerjaan_id, 'Pekerjaan Telah di Reject, Alasan (' . $data['pekerjaan_note'] . ')', $user['pegawai_nik']);
                        }
                        /* Pekerjaan */
    // deaktivasi
                        $pekerjaan_id = $this->input->get('pekerjaan_id');
    ...
    // get id bagian
                      ...
                      public function prosesApproveBerjalan()
                      {
                        ...
                        if ($this->input->get_post('id_user_staf')) {
                          $user = $this->iput->get_post('id_user_staf');
                          $user_implode = implode("','", $user);
                          $cc_not_in = $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi WHERE id_user NOT IN ('" . $user_implode . "') AND id_pekerjaan = '" . $pekerjaan_id . "' AND pekerjaan_disposisi_status = '8' AND is_cc= 'y' ")->result_array();
      // insert history hapus cc
                            foreach ($cc_not_in as $value_not_in) {
    ...
    // ubah status dokumen ke SEND
      ...
      // echo $this->db->last_query();
                            ...
                            $data_pegawai = $this->db->query("SELECT id_user,id_pekerjaan,pekerjaan_disposisi_status FROM dec.dec_pekerjaan_disposisi WHERE id_pekerjaan = '" . $pekerjaan_id . "' AND id_user = '" . $isi['pegawai_nik'] . "' AND pekerjaan_disposisi_status = '5'")->row_array();


                            $this->db->query("UPDATE dec.dec_pekerjaan_dokumen SET pekerjaan_dokumen_status = '2', is_proses = 'a', pekerjaan_dokumen_keterangan = NULL WHERE pekerjaan_dokumen_status < '2' AND id_pekerjaan = '" . $pekerjaan_id . "' AND id_create_awal IN (SELECT id_pegawai FROM global.global_bagian_detail a LEFT JOIN dec.dec_pekerjaan_disposisi b ON b.id_user = a.id_pegawai WHERE id_bagian = '" . $data_bagian['id_bagian'] . "' AND id_user = '" . $data_pegawai['id_user'] . "' AND id_pekerjaan = '" . $data_pegawai['id_pekerjaan'] . "' AND pekerjaan_disposisi_status='5')");
                            /* Dokumen */
                          }
    ...
    // }
                                ...
                                $data_pegawai = $this->db->query("SELECT id_user,id_pekerjaan,pekerjaan_disposisi_status FROM dec.dec_pekerjaan_disposisi WHERE id_pekerjaan = '" . $pekerjaan_id . "' AND id_user = '" . $isi['pegawai_nik'] . "' AND pekerjaan_disposisi_status = '9'")->row_array();

    // ubah status dokumen ke IFC
                                $data_dokumen_send = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan = '" . $this->input->get_post('pekerjaan_id') . "' AND id_create_awal IN (SELECT id_pegawai FROM global.global_bagian_detail a LEFT JOIN dec.dec_pekerjaan_disposisi b ON b.id_user = a.id_pegawai WHERE id_bagian = '" . $data_bagian['id_bagian'] . "' AND id_user = '" . $data_pegawai['id_user'] . "' AND id_pekerjaan = '" . $data_pegawai['id_pekerjaan'] . "' AND pekerjaan_disposisi_status='9') AND pekerjaan_dokumen_status <= '6' AND (is_lama !='y' OR is_lama is null) AND pekerjaan_dokumen_awal != 'y' AND is_hps = 'n' AND (is_update_ifa !='y' OR is_update_ifa is NULL)")->result_array();

                                foreach ($data_dokumen_send as $val_dokumen) {
      // cek apakah sudah ada dokumen di ifc nya
                                  $dokumen_ada = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan = '" . $this->input->get_post('pekerjaan_id') . "' AND pekerjaan_dokumen_status ='7' AND pekerjaan_dokumen_nama = '" . $val_dokumen['pekerjaan_dokumen_nama'] . "' AND id_pekerjaan_template = '" . $val_dokumen['id_pekerjaan_template'] . "' AND is_hps = 'n'")->row_array();
                                  if (!empty($dokumen_ada) && ($dokumen_ada['pekerjaan_dokumen_nama'] == $val_dokumen['pekerjaan_dokumen_nama'] && $dokumen_ada['id_pekerjaan_template'] == $val_dokumen['id_pekerjaan_template'])) {
        // skip
                                  } else {
                                ...
                                $this->db->query("UPDATE dec.dec_pekerjaan_dokumen SET is_lama = 'y' WHERE id_pekerjaan = '" . $pekerjaan_id . "' AND id_create_awal IN (SELECT id_pegawai FROM global.global_bagian_detail a LEFT JOIN dec.dec_pekerjaan_disposisi b ON b.id_user = a.id_pegawai WHERE id_bagian = '" . $data_bagian['id_bagian'] . "' AND id_user = '" . $data_pegawai['id_user'] . "' AND id_pekerjaan = '" . $data_pegawai['id_pekerjaan'] . "' AND pekerjaan_disposisi_status='9') AND (pekerjaan_dokumen_status = '0' OR pekerjaan_dokumen_status = '6') AND (is_lama !='y' OR is_lama is null) AND pekerjaan_dokumen_awal != 'y' AND is_hps = 'n'");

                                $data_dokumen_send_hps =   $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan = '" . $this->input->get_post('pekerjaan_id') . "' AND id_create_awal IN (SELECT id_pegawai FROM global.global_bagian_detail a LEFT JOIN dec.dec_pekerjaan_disposisi b ON b.id_user = a.id_pegawai WHERE id_bagian = '" . $data_bagian['id_bagian'] . "' AND id_user = '" . $data_pegawai['id_user'] . "' AND id_pekerjaan = '" . $data_pegawai['id_pekerjaan'] . "' AND pekerjaan_disposisi_status='9') AND pekerjaan_dokumen_status <= '6' AND (is_lama !='y' OR is_lama is null) AND pekerjaan_dokumen_awal != 'y' AND is_hps = 'y' AND (is_update_ifa !='y' OR is_update_ifa is NULL)")->result_array();

                                foreach ($data_dokumen_send_hps as $val_dokumen) {
                                  $dokumen_ada = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan = '" . $this->input->get_post('pekerjaan_id') . "' AND pekerjaan_dokumen_status ='7' AND pekerjaan_dokumen_nama = '" . $val_dokumen['pekerjaan_dokumen_nama'] . "' AND id_pekerjaan_template = '" . $val_dokumen['id_pekerjaan_template'] . "' AND is_hps = 'y'")->row_array();
                                  if (!empty($dokumen_ada) && ($dokumen_ada['pekerjaan_dokumen_nama'] == $val_dokumen['pekerjaan_dokumen_nama'] && $dokumen_ada['id_pekerjaan_template'] == $val_dokumen['id_pekerjaan_template'])) {
        // skip
                                  } else {
                                    $where['id_pekerjaan'] = $val_dokumen['id_pekerjaan'];
                                ...
                                $this->db->query("UPDATE dec.dec_pekerjaan_dokumen SET is_lama = 'y' WHERE id_pekerjaan = '" . $pekerjaan_id . "' AND id_create_awal IN (SELECT id_pegawai FROM global.global_bagian_detail a LEFT JOIN dec.dec_pekerjaan_disposisi b ON b.id_user = a.id_pegawai WHERE id_bagian = '" . $data_bagian['id_bagian'] . "' AND id_user = '" . $data_pegawai['id_user'] . "' AND id_pekerjaan = '" . $data_pegawai['id_pekerjaan'] . "' AND pekerjaan_disposisi_status='9') AND (pekerjaan_dokumen_status = '0' OR pekerjaan_dokumen_status = '6') AND (is_lama !='y' OR is_lama is null) AND pekerjaan_dokumen_awal != 'y' AND is_hps = 'y'");
                                $this->db->query("UPDATE dec.dec_pekerjaan_dokumen SET pekerjaan_dokumen_status = '5' WHERE id_pekerjaan = '" . $pekerjaan_id . "' AND id_create_awal = '" . $isi['pegawai_nik'] . "' AND pekerjaan_dokumen_status = '4' AND (is_lama !='y' OR is_lama is null) AND pekerjaan_dokumen_awal != 'y' AND is_hps = 'y'");
    ...
    // jika dari avp
      ...
      // update status staf ke null
                                  foreach ($data_staf as $val_staf) {
                                    $this->db->query("UPDATE dec.dec_pekerjaan_disposisi SET is_proses = NULL WHERE id_pekerjaan = '" . $this->input->get_post('pekerjaan_id') . "' AND is_aktif = 'y' AND id_user = '" . $val_staf['id_user'] . "' AND pekerjaan_disposisi_status = '9' ");
                                  }
    ...
    // ubah status jadi 9
                              ...
                              public function prosesApproveIFA()
                              {
                                ...
                                dblog('I',  $pekerjaan_id, 'Pekerjaan Telah di Reviewed Oleh PIC', $isi['pegawai_nik']);
                                /* Pekerjaan */
    ...
    // delete disposisi pic
      ...
      // $this->M_pekerjaan->updateStatusProses($where_id_user, $where_id_pekerjaan, $where_disposisi_status, $param_staf);
                                  ...
                                  dblog('I',  $pekerjaan_id, 'Pekerjaan Telah di Reject Oleh PIC', $isi['pegawai_nik']);
                                }
                                /* Pekerjaan */
                              }
                              /* Reject Pekerjaan IFA */
  ...
  public function simpanAksiIFA()
  {
    ...
    // $status_dokumen_revisi = ($this->input->get_post('pekerjaan_dokumen_status') == 'n') ? $data_status['pekerjaan_dokumen_revisi'] + 1 : '0';
    ...
    if ($this->input->get_post('pekerjaan_dokumen_status') == 'n') {
      // ambil urutan revisi sebelumnya dari dokumen di pekerjaan tersebut
      $data_revisi = $this->M_pekerjaan->getRevisiNomor($data);
      $data_revisi_isi['pekerjaan_dokumen_revisi'] = $data_revisi['max'] + 1;
      $this->M_pekerjaan->updateRevisiNomor($data_revisi_isi, $data['pekerjaan_dokumen_id']);
    }
  ...
  public function downloadDokumen()
  {
    ...
    $sql_dokumen = $this->db->query("SELECT pekerjaan_dokumen_file FROM dec.dec_pekerjaan_dokumen WHERE pekerjaan_dokumen_id = '" . $id_dokumen . "' AND  pekerjaan_dokumen_file !=''");
    $data_dokumen = $sql_dokumen->result_array();


    foreach ($data_dokumen as $key => $value) {
      if ($value['pekerjaan_dokumen_file'] == $dokumen[0]) {
        dblog('V', $this->input->get_post('pekerjaan_id'), 'Dokumen ' . $isi_template['pekerjaan_template_nama'] . ' - ' . $isi_template['pekerjaan_dokumen_nama'] . ' Telah Didownload', $isi['pegawai_nik']);
  ...
  public function getAsetDocumentIFC()
  {
    ...
    $param['pekerjaan_dokumen_status_max'] = '7';
    $param['id_user'] = $user['pegawai_nik'];
    ...
    $cust_data4 = array();
    if ($this->input->get_post('id_create') != null) {
      $data4 = $this->M_pekerjaan->getAsetDocumentUpload($param);
      print_r($data4);
      foreach ($data4 as $k4 => $cust_value4) {
        ...
        if ($cust_value4['pekerjaan_dokumen_nama'] != $nama && $cust_value4['pekerjaan_dokumen_nomor'] != $nomor && $cust_value4['id_create_awal'] != $create && $cust_value4['id_pekerjaan_template']!=$template) array_push($cust_data4, $cust_value4);
      }
      if(!empty($cust_data4)){
  ...
  public function updateAsetDocumentIFC()
  {
    ...
    if ($this->input->get_post('pekerjaan_dokumen_status') == '5' || $this->input->get_post('pekerjaan_dokumen_status') == '4') {
      $data['pekerjaan_dokumen_id'] = create_id();
      $data['id_pekerjaan'] = anti_inject($this->input->get_post('id_pekerjaan'));
      $data['pekerjaan_dokumen_nama'] = anti_inject($this->input->get_post('pekerjaan_dokumen_nama'));
      $data['id_pekerjaan_template'] = anti_inject($this->input->get_post('pekerjaan_template_nama'));
  ...
  // Ganti Perencana
          ...
          public function getStatusKoorIFC()
          {
            ...
            if ($isi_total['total'] > 0) {
              $sql_dokumen = $this->db->query("SELECT COUNT(*) AS total FROM dec.dec_pekerjaan_dokumen WHERE pekerjaan_dokumen_awal = 'n' AND is_lama = 'n' AND (pekerjaan_dokumen_status >= '6' AND pekerjaan_dokumen_status <= '7') AND id_pekerjaan = '" . $_GET['pekerjaan_id'] . "' AND is_hps = 'n' ");
              $dokumen = $sql_dokumen->row_array();

              $data_dokumen = $this->db->query("SELECT count(*) AS total FROM dec.dec_pekerjaan_dokumen WHERE pekerjaan_dokumen_awal = 'n' AND is_lama = 'n' AND (pekerjaan_dokumen_status >= '6' AND pekerjaan_dokumen_status <= '7') AND id_pekerjaan = '" . $_GET['pekerjaan_id'] . "' AND id_create_awal IN(SELECT id_pegawai FROM global.global_bagian_detail WHERE id_bagian = '" . $data_bagian_koor['id_bagian'] . "') AND is_hps = 'n' ")->row_array();
    ...
    // echo $this->db->last_query();
          ...
          public function getAsetDocumentHistory() {
            $sql = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen a LEFT JOIN dec.dec_pekerjaan_template b ON a.id_pekerjaan_template = b.pekerjaan_template_id WHERE id_pekerjaan_template = '".$_GET['id_pekerjaan_template']."' AND id_pekerjaan = '".$_GET['id_pekerjaan']."' ORDER BY CAST(pekerjaan_dokumen_status as INT) DESC");
    ...
    // echo "</pre>";
      ...
      // $user = $sql_user->row_array();
            ...
            if ($dataUser['total'] > 0 || $user['pegawai_nik'] == '2190626' || $user['pegawai_unit_id'] == 'E53000' || isset($dataUserHPS) && $dataUserHPS['total'] > 0 || isset($dataUserCC) && $dataUserCC['total'] > 0) {
              $isi = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen a LEFT JOIN dec.dec_pekerjaan_template b ON a.id_pekerjaan_template = b.pekerjaan_template_id LEFT JOIN dec.dec_pekerjaan c ON c.pekerjaan_id = a.id_pekerjaan LEFT JOIN global.global_bagian_detail d ON d.id_pegawai = a.id_create_awal LEFT JOIN global.global_bagian e ON e.bagian_id = d.id_bagian LEFT JOIN global.global_pegawai f ON f.pegawai_nik = d.id_pegawai LEFT JOIN global.global_pegawai h ON a.pekerjaan_dokumen_cc = h.pegawai_nik LEFT JOIN global.global_bidang j ON a.id_bidang = j.bidang_id LEFT JOIN global.global_urutan_proyek k ON a.id_urutan_proyek = k.urutan_proyek_id LEFT JOIN global.global_section_area l ON a.id_section_area = l.section_area_id WHERE pekerjaan_dokumen_awal = 'n' AND (is_lama != 'y' or is_lama is null) AND (pekerjaan_dokumen_status >= '6' OR pekerjaan_dokumen_status = '0') AND a.id_pekerjaan = '" . $_GET['id_pekerjaan'] . "' AND is_hps = '" . $_GET['is_hps'] . "'")->result_array();
      ...
      // jika non tender
              if (!empty($pekerjaan) && $pekerjaan['id_klasifikasi_pekerjaan'] == '616b79fa38c26380f49f3b84f088b8f86f9cd176') {
                $sql = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen a LEFT JOIN dec.dec_pekerjaan_template b ON a.id_pekerjaan_template = b.pekerjaan_template_id LEFT JOIN dec.dec_pekerjaan c ON c.pekerjaan_id = a.id_pekerjaan LEFT JOIN global.global_bagian_detail d ON d.id_pegawai = a.id_create_awal LEFT JOIN global.global_bagian e ON e.bagian_id = d.id_bagian LEFT JOIN global.global_pegawai f ON f.pegawai_nik = d.id_pegawai LEFT JOIN global.global_pegawai h ON a.pekerjaan_dokumen_cc = h.pegawai_nik LEFT JOIN global.global_bidang j ON a.id_bidang = j.bidang_id LEFT JOIN global.global_urutan_proyek k ON a.id_urutan_proyek = k.urutan_proyek_id LEFT JOIN global.global_section_area l ON a.id_section_area = l.section_area_id WHERE pekerjaan_dokumen_awal = 'n' AND (is_lama != 'y' or is_lama is null) AND pekerjaan_dokumen_status >= '4' AND pekerjaan_dokumen_status <= '5' AND a.id_pekerjaan = '" . $_GET['id_pekerjaan'] . "' AND is_hps = '" . $_GET['is_hps'] . "'");
                $data = $sql->result_array();
              } else {
      ...
      // echo $this->db->last_query();
          ...
          public function getDokumenSelesaiHPS()
          {
            ...
            if ($dataUser['total'] > 0 && $dataCC['total'] > 0 || $user['pegawai_unit_id'] == 'E53000' || (!empty($dataCC)) && $dataCC['total'] > 0 || !empty($dataCCSelesai)  && $dataCCSelesai['total'] > 0) {
