...
class Pekerjaan_langsung extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('pekerjaan_langsung', $data, FALSE);
    }
...
public function updatePekerjaanLangsungAksi()
{
    ...
    $data['pekerjaan_nilai_hps'] = preg_replace('/[^0-9]/', '', $this->input->get_post('pekerjaan_nilai_hps_aksi'));
    $data['pekerjaan_nilai_kontrak'] = preg_replace('/[^0-9]/', '', $this->input->get_post('pekerjaan_nilai_kontrak_aksi'));
