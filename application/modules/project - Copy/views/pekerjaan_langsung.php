...
<script type="text/javascript">
    ...
    function fun_hps(id) {
        ...
        $('#dg_document_hps').edatagrid({
            ...
            saveUrl: '<?= base_url("project/pekerjaan_usulan/insertAsetDocument?id_pekerjaan=") ?>' + id,
            updateUrl: '<?= base_url("project/pekerjaan_usulan/updateAsetDocumentLangsung?id_pekerjaan=") ?>' + id,
            onBeginEdit: function(index, row) {
                /* Combobox */
                var cb = $(this).datagrid('getEditor', {
                    index: index,
