                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#usulan" onclick="div_usulan()" id="link_div_usulan">Usulan <input hidden type="text" id="notif_usulan_reject_rkap"><span class="badge bg-primary fload_end" id="notif_usulan_rkap"></span></a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#berjalan" onclick="div_berjalan()" id="link_div_berjalan">Berjalan <span class="badge bg-secondary fload_end" id="notif_berjalan_rkap"></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#ifa" onclick="div_ifa()" id="link_div_ifa">IFA <span class="badge bg-success fload_end" id="notif_ifa_rkap"></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#ifc" onclick="div_ifc()" id="link_div_ifc">IFC <span class="badge bg-warning fload_end" id="notif_ifc_rkap"></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#selesai" onclick="div_selesai()" id="link_div_selesai">Selesai <span class="badge bg-dark fload_end" id="notif_selesai_rkap"></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- End Tab -->
        ...
        $(function() {
            ...
            if ($('#pegawai_jabatan').val() == '2') {
              ...
              if ($('#jabatan_atasan').val() == '2') {
                ...
                var newOption = new Option($('#nama_atasan').val()+' - '+$('#postitle_atasan').val(), $('#nik_atasan').val(), true, true);
                $('#reviewer').append(newOption).trigger('change');
                $.getJSON('<?=base_url()?>project/RKAP/getUserListRevApp2', {param1: $('#direct_superior_atasan').val()}, function(json) {
...
function fun_edit(id) {
    ...
    $.getJSON('<?= base_url() ?>project/pekerjaan_usulan/getPekerjaanUsulan?pekerjaan_id=' + id, function(json) {
        ...
        $('#pekerjaan_tahun').val(json.pekerjaan_tahun);
                ...
                /*SELECTED SELECT2*/
        $.getJSON('<?=base_url()?>project/RKAP/getUserListRevApp2', {pegawai_nik: json.pekerjaan_reviewer}, function(jsonReviewer) {
          var newOption = new Option(jsonReviewer.text, jsonReviewer.id, true, true);
          $('#reviewer').append(newOption).trigger('change');
      });

        $.getJSON('<?=base_url()?>project/RKAP/getUserListRevApp2', {pegawai_nik: json.pekerjaan_approver}, function(jsonApprover) {
