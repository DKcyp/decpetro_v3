    ...
    <div class="row" id="div_home">
      ...
      <div class="col-lg-12">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <?php
                $cek = $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi WHERE is_proses IS NULL AND id_pekerjaan = '" . $this->input->get('pekerjaan_id') . "' AND pekerjaan_disposisi_status IN('5','6') AND id_penanggung_jawab != 'y'")->num_rows();
                if ($cek > '0') {
                  ?>
                  <div class="card-body" id="div_cek_proses_berjalan">
                    <span style="float: right;" class="alert alert-warning">Masih ada perencana yg belum melakukan upload dokumen</span>
                  </div>
                  <button type="button" class="btn btn-success col-2 float-end" onclick="funcApproveDokumenAVP(<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>)" id="btn_approve_dokumen_avp" style="display:none">
                    Approve All Dokumen
                  </button>
                  ...
                  <button type="button" class="btn btn-info col-2 float-end" onclick="funcApproveDokumenAVP(<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>)" id="btn_approve_dokumen_avp" style="display:none">
                    Approve All Dokumen
                  </button>
                  <?php
                }
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary col-2 float-end" id="btn_cc_ifa" onclick="fun_cc_ifa('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')" style="display: none;">CC Dokumen</button>
                <button type="button" class="btn btn-primary col-2 float-end" id="btn_cc_hps_ifa" onclick="fun_cc_hps_ifa('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')" style="display: none;">CC HPS</button>
        ...
        <?php elseif ($_GET['aksi'] == 'ifc') : ?>
          ...
          <div class="col-lg-12">
            <div class="card">
              <?php $cek = $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi WHERE is_proses IS NULL AND id_pekerjaan = '" . $this->input->get('pekerjaan_id') . "' AND pekerjaan_disposisi_status IN('11','12') AND id_penanggung_jawab != 'y'")->num_rows(); ?>
              <div class="card-body">
                <?php if ($cek > '0') : ?>
                ...
                <!-- Tombol -->
                <?php if ($cek == '0') : ?>
                  <button type="button" class="btn btn-success col-2 float-end m-1" onclick="funcModalSendVPIFC(<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>)" id="btn_send_avp_ifc" style="display:none">
                    Send VP
                  </button>
                <?php endif ?>
                ...
                <button type="button" class="btn btn-danger col-2 float-end" id="btn_revisi" onclick="fun_reject_berjalan_ifc('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')" style="display: none;">Revisi</button>
                <!-- Tombol -->
              </div>
            </div>
          </div>
          ...
          <div class="card scroll">
            <div class="card-body">
              <div class="tree">
                ...
                <ul>
                  <li>
                    <a href="javascript:0;">pertama</a>
                    
                    <ul>
                      <li>
                        <a href="javascript:0;">kedua</a>
                        
                        <ul>
                          <li>
                            <a href="javascript:0;">ketiga</a>

                            <ul>
                              <li>
                                <a href="javascript:0;">keempat</a>
                                
                                <ul>
                                  <li>
                                    <a href="javascript:0;">kelima</a>

                                    <ul>
                                      <li>
                                        <a href="javascript:0;">keenam</a>
                                      </li>
                                    </ul>
  ...
  $(function() {
    ...
    $.getJSON('<?= base_url('project/pekerjaan_usulan/getPekerjaan') ?>', {
      ...
      if ('<?= $_GET['aksi'] ?>' == 'usulan') {
        ...
        if (json.pekerjaan_status == '1') {
        ...
        } else if (json.pekerjaan_status == '4' && json.is_proses == 'y' && json.id_penanggung_jawab == 'y' && json.id_koor_baru != '') {
          $('#btn_reviewed').css('display', 'none');
          $('#btn_approve').css('display', 'none');
          $('#btn_disposisi_vp').css('display', 'none');
          $('#btn_disposisi_avp').css('display', 'none');
          ...
          $('#btn_reject_avp').css('display', 'none');
          $('#btn_ganti_koor').css('display', 'block');
          ...
          $('#btn_reject').css('display', 'none');
          $('#btn_reject_avp').css('display', 'none');
          $('#btn_ganti_koor').css('display', 'none');
          /* Approved VP Cangun */
        } else if (json.pekerjaan_status == '4' && json.id_penanggung_jawab == 'y') {
          /* Reviewed AVP Cangun Koor */
          $('#btn_reviewed').css('display', 'none');
          $('#btn_approve').css('display', 'none');
          $('#btn_disposisi_vp').css('display', 'none');
          ...
          $('#btn_ganti_koor').css('display', 'block');
          /* Reviewed AVP Cangun Koor */
        } else if (json.pekerjaan_status == '4' && json.id_penanggung_jawab == 'n') {
          /* Reviewed AVP Cangun Terkait */
          $('#btn_reviewed').css('display', 'none');
          $('#btn_approve').css('display', 'none');
          $('#btn_disposisi_vp').css('display', 'none');
          $('#btn_disposisi_avp').css('display', 'block');
        ...
        if (json.pekerjaan_status == '5' && json.pekerjaan_disposisi_status == '6' && json.is_proses == 'y' && json.id_penanggung_jawab == 'y') {
          ...
          $('#btn_penomoran').css('display', 'none');
          $('#btn_nilai_hps').css('display', 'none');
          ...
          $('#div_cek_proses_berjalan').hide();
          // Upload File Satf Cangun dan Sudah Diproses
        } else if (json.pekerjaan_status == '5' && json.id_penanggung_jawab == 'n') {
          ...
          $('#btn_upload_hps').css('display', 'block');
          $('#btn_progress').css('display', 'block');
          $('#btn_penomoran').css('display', 'block');
          $('#btn_nilai_hps').css('display', 'block');
          $('#btn_send_ifa').css('display', 'block');
          $('#btn_send_avp').css('display', 'none');
          $('#btn_approve_dokumen_avp').hide();
          $('#btn_send_avp_koor').css('display', 'none');
          ...
          $('#btn_reject_staf').hide();
          $('#btn_ganti_perencana').hide();
        } else if (json.pekerjaan_status == '8' && json.id_user == '<?= $data_session['pegawai_nik'] ?>' && json.is_cc != '' && json.is_pic != 'y') {
          /* Approve PIC */
          $('#btn_upload').css('display', 'none');
          $('#btn_upload_hps').css('display', 'none');
          $('#btn_progress').css('display', 'none');
          ...
          $('#btn_approve_ifa').css('display', 'none');
          $('#btn_revisi_ifa').css('display', 'none');
          $('#btn_cc_ifa').css('display', 'inline-block');
          // $('#btn_cc_hps_ifa').css('display', 'inline-block');
          $('#btn_reject_staf').hide();
          $('#btn_ganti_perencana').hide();
          ...
          $('#btn_revisi_ifa').show();
        } else if (json.pekerjaan_status == '11' && (json.pekerjaan_disposisi_status == '12' || json.disposisi_status_sekarang == '12') && (json.id_penanggung_jawab == 'y' || json.status_tanggung_jawab_sekarang == 'y')) {
          /* Upload File Staf Cangun */
          ...
          $('#btn_reject_staf').hide();
          $('#btn_ganti_perencana').hide();
        } else if (json.pekerjaan_status == '11' && (json.pekerjaan_disposisi_status == '12' || json.disposisi_status_sekarang == '12') && (json.id_penanggung_jawab == 'n' || json.status_tanggung_jawab_sekarang == 'n')) {
          /* Upload File Staf Cangun */
          $('#btn_upload_ifc').css('display', 'none');
          $('#btn_progress').css('display', 'none');
          $('#btn_penomoran').css('display', 'none');
          ...
          $('#btn_ganti_perencana').hide();
          /* Reviewed AVP Cangun */
        } else if ((json.pekerjaan_status == '12' && json.id_penanggung_jawab == 'y') || (json.disposisi_status_sekarang == '12' && json.status_tanggung_jawab_sekarang == 'y')) {
          /* Reviewed AVP Cangun */
          $('#btn_upload').css('display', 'none');
          $('#btn_progress').css('display', 'none');
          $('#btn_send_ifa').css('display', 'none');
        ...
        } else if ((json.pekerjaan_status == '12' && json.id_penanggung_jawab == 'n') || (json.disposisi_status_sekarang == '12' && json.status_tanggung_jawab_sekarang == 'n')) {
          /* Reviewed AVP Cangun */
          $('#btn_upload').css('display', 'none');
          $('#btn_progress').css('display', 'none');
          $('#btn_send_ifa').css('display', 'none');
...
function fun_cc_ifa(id) {
  ...
  $.getJSON('<?= base_url('project/pekerjaan_usulan/getUserStafVP') ?>', {
    ...
    $.each(data, function(index, val) {
      $('#' + index).val();
      $('#cc_ifa').append('<option selected value="' + val.id_user + '">' + val.pegawai_nama + ' - ' + val.pegawai_postitle + '</option>')
    });
  });
...
function fun_cc_hps_ifa(id) {
  ...
  $.getJSON('<?= base_url('project/pekerjaan_usulan/getUserStafVP') ?>', {
    ...
    $.each(data, function(index, val) {
      $('#' + index).val();
      $('#cc_hps_ifa').append('<option selected value="' + val.id_user + '">' + val.pegawai_nama + ' - ' + val.pegawai_postitle + '</option>')
    });
  });
