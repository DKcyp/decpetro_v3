...
<body>
  <table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        ?>
          <table class="table" width="100%" border="1" cellspacing="0" cellpadding="0">
            <tr>
              ...
              ?>
              <td align="center" rowspan="2" width="30%" class="isiText">
                <?php echo (!empty($template)) ? $template['pekerjaan_template_nama'] : '' ?>
                <br>
                Bidang
                <br>
              ...
              <td style="padding-left: 5px;font-size:10pt" width="20%">
                No. Pekerjaan :
                <br>
                <?= (!empty($pekerjaan)) ? $pekerjaan['pekerjaan_nomor'] : '' ?>
              </td>
              <td style="text-align:center;font-size:13pt">
                ...
                ?>
                <?= ($template['pekerjaan_dokumen_revisi'] && $cek_approve_vp > 0) ? $template['pekerjaan_dokumen_revisi'] : '0'   ?>
            ...
            <tr>
              ...
              <td colspan="1" style="text-align: center;font-size:13pt">
                Lembar
                <br>
                <?= (!empty($template)) ? $template['pekerjaan_dokumen_jumlah'] : '' ?>
              </td>
            </tr>
          </table>
          <!-- ukuran kertas A4 Potrait -->
          <!-- ukuran kertas A3 Landscapek -->
        <?php



        elseif ($template['pekerjaan_dokumen_kertas'] == 'A3' && $template['pekerjaan_dokumen_orientasi'] == 'Landscape') :
        ?>
          <!-- ukuran kertas A3 Landscapek -->
          <table class="table" width="100%" border="1" cellspacing="0" cellpadding="0">
            <tr>
              ...
              ?>
              <td align="center" rowspan="3" width="<?= $width_bidang ?>" class="isiText">
                <?php echo (!empty($template)) ? $template['pekerjaan_template_nama'] : '' ?>
                <br>
                Bidang
                <br>
              ...
              <td style="text-align:center;font-size:10pt" rowspan="3" width="6%">
                Revisi
                <br>
                <?php $cek_approve_vp = $this->db->query("SELECT * FROM dec.dec_pekerjaan_dokumen WHERE id_pekerjaan='" . $template['id_pekerjaan'] . "' and is_lama ='n' and pekerjaan_dokumen_awal='n' AND (pekerjaan_dokumen_status = '4' OR pekerjaan_dokumen_status = '11' ) AND pekerjaan_dokumen_nomor = '" . $template['pekerjaan_dokumen_nomor'] . "'")->num_rows();
                ?>
          ...
          <table class="table" width="100%" border="1" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td style="padding-left: 5px;" width="15%">
                ...
                <br>
                <center>
                  <b style="font-size: 9pt;"><?= (!empty($pekerjaan)) ? $pekerjaan['pekerjaan_nomor'] : '' ?></b>
                </center>
              </td>
            ...
            <tr>
              <td colspan="1" style="padding-left: 5px;font-size: 9pt;">No Dokumen
                <br>
                <center>
    ...
    <tr>
      ...
      <!-- <td colspan="2" height="<?php echo ($template['pekerjaan_dokumen_kertas'] == 'A4' && $template['pekerjaan_dokumen_orientasi'] == 'Landscape') ? '450px' : '600px' ?>" align="center">
        <span class="isiText">Nama Pekerjaan/Proyek : </span>
        <p class="text-muted isiText" style="font-weight: bold;font-size:18pt">
          <?= (!empty($pekerjaan)) ? $pekerjaan['pekerjaan_judul'] : '' ?>
        </p>
        <span class="isiText">Client : </span>
        <p class="text-muted isiText" style="font-weight: bold;font-size:18pt">
          <?= (!empty($pekerjaan)) ? $pekerjaan['pegawai_nama_dep'] : '' ?>
        </p>
        <span class="isiText">Location : </span>
        <p class="text-muted isiText" style="font-weight: bold;font-size:18pt">
          Gresik
        </p>
      </td> -->
        ...
        <table border="1" width="100%" align="center" class="table">
          ...
          if ($template['is_hps'] == 'n') {
            ...
            if ($template['pekerjaan_dokumen_status'] >= '5' && $template['pekerjaan_dokumen_status'] <= '7') {
              ...
              $sql_dokumen = $this->db->query("SELECT id_pekerjaan_template,pekerjaan_template_nama, to_char(pekerjaan_waktu,'dd-mm-yyyy') as pekerjaan_waktunya,to_char(pekerjaan_dokumen_waktu,'dd-mm-yyyy') as pekerjaan_dokumen_waktunya,pekerjaan_dokumen_revisi,pekerjaan_dokumen_status,pekerjaan_id FROM dec.dec_pekerjaan a LEFT JOIN dec.dec_pekerjaan_dokumen b ON b.id_pekerjaan = a.pekerjaan_id LEFT JOIN dec.dec_pekerjaan_template C ON c.pekerjaan_template_id = b.id_pekerjaan_template WHERE pekerjaan_id = '" . $_GET['pekerjaan_id'] . "' AND is_hps = '" . $template['is_hps'] . "' AND id_create_awal = '" . $template['id_create_awal'] . "' AND id_pekerjaan_template = '" . $template['id_pekerjaan_template'] . "' AND pekerjaan_dokumen_status >='4' AND pekerjaan_dokumen_status <='6' AND pekerjaan_dokumen_waktu IS NOT NULL AND is_lama = 'n' GROUP BY to_char(pekerjaan_waktu,'dd-mm-yyyy'),to_char(pekerjaan_dokumen_waktu,'dd-mm-yyyy'),pekerjaan_dokumen_revisi,pekerjaan_dokumen_status,pekerjaan_id,id_pekerjaan_template,pekerjaan_template_nama ORDER BY CAST(pekerjaan_dokumen_status as INT) DESC,pekerjaan_dokumen_revisi DESC");
            }
          }
          /*Status DOkumen*/
          /* Dokumen */
    ...
    <tr>
      <td colspan="6">
        <center><span style="bottom:0;font-size:8pt;text-align:center">Engineering Department PT. Petrokimia Gresik</span></center>
      </td>
    </tr>
    </td>
    </tr>
