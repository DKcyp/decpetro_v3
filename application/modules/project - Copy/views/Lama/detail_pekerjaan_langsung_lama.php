...
$sql_disposisi = $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik WHERE a.is_aktif = 'y' AND a.id_pekerjaan = '" . $_GET['pekerjaan_id'] . "' ORDER BY CAST(pekerjaan_disposisi_status AS INT) ASC");
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-12">
      <a href="javascript:void(0);" onclick="window.close()" class="btn btn-success"><u><i class="fa fa-arrow-left"></i> Tutup</u></a>
      <!-- <a href="javascript:void(0);" onclick="call_ajax_page('project/pekerjaan_langsung')" class="btn btn-success"><u><i class="fa fa-arrow-left"></i> Kembali</u></a> -->
      <center><h4 class="card-title mb-4">Pekerjaan</h4></center>
    </div>
  </div>
  <!-- end page title -->
          ...
          <div class="row task-dates">
            ...
            <?php elseif ($_GET['aksi'] == 'ifc') : ?>
              ...
              <div class="col-sm-4 col-md-3" id="btn_upload_ifc" style="display: none;">
                <div class="mt-4">
                  <button type="button" class="btn btn-success col-10" onclick="fun_upload_ifc('<?= $this->input->get('pekerjaan_id') ?>','<?= $_GET['status'] ?>')">Upload Data</button>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <button type="button" class="btn btn-success col-1 float-end" id="btn_approve_ifa" onclick="fun_approve_ifa('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>', 'Apakah Anda Yakin Approved?')" style="display: none;">Approve IFA</button>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <button type="button" class="btn btn-success col-1 float-end" onclick="funcModalApproveVP(<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>)" id="btn_approve_vp" style="display:none">
                  Approve VP
                </button>
                <button type="button" class="btn btn-danger col-1 float-end" id="btn_revisi" onclick="fun_reject_berjalan('<?= preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>')" style="display: none;">Revisi</button>
                <!-- Tombol -->
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="tree">
                      ...
                      $sql_cc = $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik WHERE id_pekerjaan ='" . $_GET['pekerjaan_id'] . "' AND is_cc='y' AND is_aktif = 'y'");
                      $data_cc = $sql_cc->result_array();

                    // CC
                      $total = 100;
                      if ($dataJumlah[0]['pekerjaan_disposisi_status'] == '3') {
                        $total = (COUNT($data_cc) != NULL) ? 70 : 100;
                        $totalCC = (COUNT($data_cc) != NULL) ? 30 / COUNT($data_cc) : 0;
                      }
                    // CC
                      ?>
                      <!-- PERTAMA -->
                      <ul>
                        <?php if (isset($dataJumlah)) : ?>
                          <!-- CC -->
                          <?php if ($dataJumlah[0]['pekerjaan_disposisi_status'] == '3') : ?>
                          ...
                          <li style="width: <?= $total ?>%">
                            ...
                            // CC
                              if ($dataJumlah[0]['pekerjaan_disposisi_status'] == '2') {
                                $total1 = (COUNT($data_cc) != NULL) ? 70 : 100;
                                $totalCC1 = (COUNT($data_cc) != NULL) ? 30 / COUNT($data_cc) : 0;
                              }
                            // CC
                              ?>
                              <?php if (isset($data1)) : ?>
                                  ...
                                  <?php foreach ($data1 as $value1) : ?>
                                    <li style="width: <?= $total1; ?>%">
                                      ...
                                      <?php if (isset($dataJumlah[1]['pekerjaan_disposisi_status'])) : ?>
                                        <?php
                                        $sql_2 = ($dataJumlah[1]['pekerjaan_disposisi_status'] <= 4) ? $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik LEFT JOIN global.global_bagian_detail c ON c.id_pegawai = a.id_user LEFT JOIN global.global_bagian d ON d.bagian_id = c.id_bagian WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[1]['pekerjaan_disposisi_status'] . "'") : $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik LEFT JOIN global.global_bagian_detail c ON c.id_pegawai = a.id_user LEFT JOIN global.global_bagian d ON d.bagian_id = c.id_bagian WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[1]['pekerjaan_disposisi_status'] . "' AND b.pegawai_direct_superior = '" . $value1['pegawai_poscode'] . "'");
                                        $data2 = $sql_2->result_array();

                                        $total2 = (COUNT($data2) != NULL) ? 100 / COUNT($data2) : 0;
                                      // CC
                                        if ($dataJumlah[1]['pekerjaan_disposisi_status'] == '2') {
                                          $total2 = (COUNT($data_cc) != NULL) ? 70 : 100;
                                          $totalCC2 = (COUNT($data_cc) != NULL) ? 30 / COUNT($data_cc) : 0;
                                        }
                                      // CC
                                        ?>
                                        <?php if (isset($data2)) : ?>
                                          ...
                                          <ul>
                                            <!-- CC -->
                                            <?php if ($dataJumlah[1]['pekerjaan_disposisi_status'] == '2') : ?>
                                              <?php foreach ($data_cc as $value_cc) : ?>
                                            ...
                                            <?php foreach ($data2 as $value2) : ?>
                                              <li style="width:<?= $total2; ?>%">
                                                ...
                                                <?php if (isset($dataJumlah[2]['pekerjaan_disposisi_status'])) : ?>
                                                  <?php
                                                  $sql_3 = ($dataJumlah[2]['pekerjaan_disposisi_status'] <= 4) ? $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik LEFT JOIN global.global_bagian_detail c ON c.id_pegawai = a.id_user LEFT JOIN global.global_bagian d ON d.bagian_id = c.id_bagian WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[2]['pekerjaan_disposisi_status'] . "'") : $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik LEFT JOIN global.global_bagian_detail c ON c.id_pegawai = a.id_user LEFT JOIN global.global_bagian d ON d.bagian_id = c.id_bagian WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[2]['pekerjaan_disposisi_status'] . "' AND d.bagian_id = '" . $value2['bagian_id'] . "'");
                                                    ...
                                                    <?php foreach ($data3 as $value3) : ?>
                                                      <li style="width: <?= $total3; ?>%">
                                                        ...
                                                        <?php if (isset($dataJumlah[3]['pekerjaan_disposisi_status']) && $dataJumlah[3]['pekerjaan_disposisi_status'] != 6) : ?>
                                                          <?php
                                                          $sql_4 = ($dataJumlah[3]['pekerjaan_disposisi_status'] <= 4) ? $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik LEFT JOIN global.global_bagian_detail c ON c.id_pegawai = a.id_user LEFT JOIN global.global_bagian d ON d.bagian_id = c.id_bagian WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[3]['pekerjaan_disposisi_status'] . "'") : $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik LEFT JOIN global.global_bagian_detail c ON c.id_pegawai = a.id_user LEFT JOIN global.global_bagian d ON d.bagian_id = c.id_bagian WHERE is_aktif = 'y' AND id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[3]['pekerjaan_disposisi_status'] . "' AND d.bagian_id = '" . $value3['bagian_id'] . "'");
                                                          ...
                                                          ?>
                                                          <?php if (isset($cust_data4)) : ?>
                                                            <!-- KELIMA -->
                                                            <ul>
                                                              <?php foreach ($cust_data4 as $value4) : ?>
                                                                <li style="width: <?= $total4; ?>%">
                                                                  ...
                                                                  <?php if (isset($dataJumlah[4]['pekerjaan_disposisi_status']) && $dataJumlah[4]['pekerjaan_disposisi_status'] != 6) : ?>
                                                                    <?php
                                                                    $sql_5 = ($dataJumlah[4]['pekerjaan_disposisi_status'] <= 3) ? $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik LEFT JOIN global.global_bagian_detail c ON c.id_pegawai = a.id_user LEFT JOIN global.global_bagian d ON d.bagian_id = c.id_bagian WHERE is_aktif = 'y' AND a.id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[4]['pekerjaan_disposisi_status'] . "' AND d.bagian_id = '" . $value4['bagian_id'] . "'") : $this->db->query("SELECT * FROM dec.dec_pekerjaan_disposisi a LEFT JOIN global.global_pegawai b ON a.id_user = b.pegawai_nik LEFT JOIN global.global_bagian_detail c ON c.id_pegawai = a.id_user LEFT JOIN global.global_bagian d ON d.bagian_id = c.id_bagian WHERE is_aktif = 'y' AND a.id_pekerjaan = '" . preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) . "' AND pekerjaan_disposisi_status = '" . $dataJumlah[4]['pekerjaan_disposisi_status'] . "'  AND d.bagian_id = '" . $value4['bagian_id'] . "'");
        ...
        <div class="modal-body">
          <form id="form_upload_dokumen_ifc">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" id="close_dokumen_ifc" class="btn btn-primary" onclick="fun_close_dokumen_ifc()">Draft</button>
  ...
  },
  {
    "render": function(data, type, full, meta) {
      if (full.pekerjaan_dokumen_file === null || full.pekerjaan_dokumen_file === '') {
        ...
        return '<center><a href="./document/'+full.pekerjaan_dokumen_file+'" target="_blank" id="' + full.pekerjaan_dokumen_file + '" title="Lihat"><i class="bx bx-book m-0"></i></a></center>';
      }
    }
  }, {
    "render": function(data, type, full, meta) {
...
$('#table_dokumen').DataTable({
  "ajax": {
    "url": "<?= base_url('project/pekerjaan_usulan/') ?>getAsetDocument?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=n&id_user=<?= $_GET['id_user'] ?>",
    "dataSrc": ""
  },
  "columns": [{
    render: function(data, type, full, meta) {
  ...
  },
  {
    "render": function(data, type, full, meta) {
      ...
      if (full.pekerjaan_dokumen_status == '0') {
        ...
        var data = 'Menunggu Review AVP';
      } else if (full.pekerjaan_dokumen_status == '3') {
        var data = 'Menunggu Approve VP';
        ...
        var data = 'Approved AVP IFC'
      } else if (full.pekerjaan_dokumen_status == '9') {
        var data = 'Approved VP IFC';
  ...
  },
  {
    "render": function(data, type, full, meta) {
      ...
      } else if (full.is_proses == 'y' && full.vp == 'y' && full.pekerjaan_dokumen_status != '0') {
        aksi = '<center><a href="javascript:;" id="' + full.pekerjaan_dokumen_id + '" title="Aksi" onclick="fun_aksi(this.id)"><i class="fa fa-share"></i></a></center>';
...
$('#table_dokumen_hps').DataTable({
  "ajax": {
    "url": "<?= base_url('project/pekerjaan_usulan/') ?>getAsetDocument?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&id_user=<?= $_GET['id_user'] ?>&is_hps=y",
    "dataSrc": ""
  },
  "columns": [{
    render: function(data, type, full, meta) {
...
$('#table_dokumen_ifa').DataTable({
  "ajax": {
    "url": "<?= base_url('project/pekerjaan_usulan/') ?>getAsetDocument?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&id_user=<?= $_GET['id_user'] ?>&is_hps=n",
    "dataSrc": ""
  },
  "columns": [{
    render: function(data, type, full, meta) {
...
$('#table_dokumen_ifa_hps').DataTable({
  "ajax": {
    "url": "<?= base_url('project/pekerjaan_usulan/') ?>getAsetDocument?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=y&id_user=<?= $_GET['id_user'] ?>",
    "dataSrc": ""
  },
  "columns": [{
    render: function(data, type, full, meta) {
...
$('#table_dokumen_ifc').DataTable({
  "ajax": {
    "url": "<?= base_url('project/pekerjaan_usulan/') ?>getAsetDocumentIFC?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=n",
    "dataSrc": ""
  },
  "columns": [{
    render: function(data, type, full, meta) {
...
$('#table_dokumen_ifc_hps').DataTable({
  "ajax": {
    "url": "<?= base_url('project/pekerjaan_usulan/') ?>getAsetDocumentIFC?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=y",
    "dataSrc": ""
  },
  "columns": [{
    render: function(data, type, full, meta) {
...
$('#table_dokumen_selesai').DataTable({
  "ajax": {
    "url": "<?= base_url('project/pekerjaan_usulan/') ?>getAsetDocument?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=n",
    "dataSrc": ""
  },
  "columns": [{
    render: function(data, type, full, meta) {
...
$('#table_dokumen_selesai_hps').DataTable({
  "ajax": {
    "url": "<?= base_url('project/pekerjaan_usulan/') ?>getAsetDocument?id_pekerjaan=<?php echo preg_replace("/[^0-9^a-z^A-Z]/", "", $_GET['pekerjaan_id']) ?>&pekerjaan_status=<?= $_GET['status'] ?>&is_hps=y",
    "dataSrc": ""
  },
  "columns": [{
    render: function(data, type, full, meta) {
...
function fun_approve(id, text) {
  Swal.fire({
    ...
    if (result.value) {
      // if ($('#is_rkap').val() == '1') {
      //   call_ajax_page('project/RKAP');
      // } else {
      //   call_ajax_page('project/pekerjaan_langsung');
      // }
...
function fun_disposisi_vp(id) {
  ...
  $.getJSON('<?= base_url('project/pekerjaan_langsung/getVPPJ') ?>', {
    ...
    $.each(json, function(index, val) {
      $('#' + index).val(val);
        // console.log(val);
      $('#id_tanggung_jawab_vp').append('<option selected value="' + val.id_user + '">' + val.pegawai_nama + '</option>');
    });
  });
  ...
  $.getJSON('<?= base_url('project/pekerjaan_langsung/getVPTerkait') ?>', {
    ...
    $.each(json, function(index, val) {
      $('#' + index).val(val);
        // console.log(val);
      $('#id_user_vp').append('<option selected value="' + val.id_user + '">' + val.pegawai_nama + '</option>');
    });
  })
}
  /* Klik Disposisi VP */
...
function fun_disposisi_avp(id) {
  ...
  $.getJSON('<?= base_url('project/pekerjaan_langsung/getVPAVP') ?>', {
    ...
    $.each(json, function(index, val) {
      $('#' + index).val(val);
      $('#id_user_vp_avp').append('<option selected value="' + val.id_user + '">' + val.pegawai_nama + '</option>');
  ...
  $.getJSON('<?= base_url('project/pekerjaan_langsung/getAVP') ?>', {
    ...
    $.each(json, function(index, val) {
      $('#' + index).val(val);
      $('#id_user_avp').append('<option selected value="' + val.id_user + '">' + val.pegawai_nama + '</option>');
    });
  });
...
function fun_upload_ifc(id, val) {
  ...
  setTimeout(function() {
    $('#dg_document_ifc').edatagrid({
      url: '<?= base_url("project/pekerjaan_usulan/getAsetDocumentIFC?pekerjaan_dokumen_status=n&id_pekerjaan=") ?>' + id + '&pekerjaan_status=' + val + '&id_user=<?= $_GET['id_user'] ?>&id_create=' + $('#session_user').val(),
...
function fun_approve_ifa(id, text) {
  Swal.fire({
    ...
    if (result.value) {
        // call_ajax_page('project/dokumen_IFA');
      // if ($('#is_rkap').val() == '1') {
      //   call_ajax_page('project/RKAP');
      // } else {
      //   call_ajax_page('project/pekerjaan_langsung');
...
$('#form_modal_send_vp').on('submit', function(e) {
  ...
  $.ajax({
    ...
    success: function(isi) {
      ...
      setTimeout(function() {
        window.close()
      }, 1500);        // $('#table_dokumen_ifa').DataTable().ajax.reload(null, false);
    }
  })
})
  /*Proses Send VP */
...
$('#form_modal_send_vp_koor').on('submit', function(e) {
  e.preventDefault();
  var url = '<?= base_url('project/pekerjaan_usulan/prosesSendVPKoor') ?>';
  $.ajax({
    url: url,
      // data: $('#form_modal_send_vp').serialize(),
    data: {
...
$('#form_modal_send_vp_ifc').on('submit', function(e) {
  ...
  $.ajax({
    ...
    data: {
      ...
      pekerjaan_status: $('#pekerjaan_status').val(),
      id_user_send_vp: $('#id_user_send_vp_ifc').val()
    },
    type: 'POST',
    dataType: 'HTML',
      // processData: false,
...
$('#form_modal_approve_vp').on('submit', function(e) {
  ...
  $.ajax({
    ...
    data: {
      ...
      pekerjaan_status: $('#pekerjaan_status').val(),
      id_user_approve_vp: $('#id_user_approve_vp').val(),
      id_user_approve_vp_hps: $('#id_user_approve_vp_hps').val(),
...
function fun_refresh(id, isi) {
  ...
  else if (parseInt(data[1]) == '8') var aksi = 'ifa';
  else if (parseInt(data[1]) >= '9' && parseInt(data[1]) <= '11') var aksi = 'ifc';
  else var aksi = 'selesai';
    // console.info(aksi);
  // call_ajax_page('project/pekerjaan_langsung/detailPekerjaan?aksi=' + aksi + '&pekerjaan_id=' + id + '&status=' + parseInt(data[1]) + '&rkap=0&id_user=' + data[0]);

  // var url = "<?=base_url('project/pekerjaan_langsung/detailPekerjaan?aksi=')?>"+aksi+"&pekerjaan_id="+id+"&status="+parseInt($data[1])+"&rkap=0&id_user="+data[0]);
