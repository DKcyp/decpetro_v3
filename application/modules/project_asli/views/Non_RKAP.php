...
var table_ifa = $('#table_ifa').DataTable({
    ...
    "scrollX": true,
    "ajax": {
        "url": "<?= base_url('project/') ?>pekerjaan_usulan/getPekerjaanUsulan?klasifikasi_pekerjaan_id_non_rkap=1&pekerjaan_status=8,9,10",
        "dataSrc": ""
    },
    "columns": [{
        render: function(data, type, full, meta) {
    ...
    initComplete: function() {
        ...
        .each(function(colIdx) {
            ...
            .on('keyup change', function(e) {
                ...
                // "scrollX": true,
    "ajax": {
        "url": "<?= base_url() ?>project/pekerjaan_usulan/getPekerjaanUsulan?klasifikasi_pekerjaan_id_non_rkap=1&pekerjaan_status=11,12,13",
        "dataSrc": ""
    },
    "columns": [{
        render: function(data, type, full, meta) {
...
$('#cari_filter').on('click', function(e) {
    ...
    $('#table_selesai').DataTable().ajax.url('<?= base_url('project/pekerjaan_usulan/getPekerjaanUsulan?klasifikasi_pekerjaan_id_non_rkap=1&pekerjaan_status=14,15,16&') ?>' + data).load();
})
...
function fun_edit(id) {
    ...
    $.getJSON('<?= base_url() ?>project/pekerjaan_usulan/getPekerjaanUsulan?pekerjaan_id=' + id, function(json) {
        console.log(json.pekerjaan_deskripsi);
