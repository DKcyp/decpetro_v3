...
PDFAnnotate.prototype.saveToServer = function (link,filename,dokumen_id) {
	var inst = this;
	var doc =  new jspdf.jsPDF();
	$.each(inst.fabricObjects, function (index, fabricObj) {
		if (index != 0) {
	...
	var dokumen_id = dokumen_id;
	var formData = new FormData();
	formData.append('file', file);
	formData.append('filename',filename);
	formData.append('pekerjaan_dokumen_id',dokumen_id)
	...
	jQuery.ajax(link,
	{
		...
		beforeSend:function(data){
			$('#loadingsimpanPDF').show();
		},
		success: function(data){
			$("#simpan_aksi_dokumen").show();
			toastr.success('Berhasil');
			$('#loadingsimpanPDF').hide();
		},
