                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            <input hidden type="text" id="pekerjaan_status_nama" name="pekerjaan_status_nama" value="usulan" hidden="hidden">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="javascript:;" onclick="div_usulan()" id="link_div_usulan">Usulan <input type="text" id="notif_usulan_reject_non_rkap" hidden><span class="badge bg-primary float-end" id="notif_usulan_non_rkap"></span> </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:;" onclick="div_berjalan()" id="link_div_berjalan">Berjalan <span class="badge bg-secondary float-end" id="notif_berjalan_non_rkap"></span> </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:;" onclick="div_ifa()" id="link_div_ifa">IFA <span class="badge bg-success float-end" id="notif_ifa_non_rkap"></span> </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:;" onclick="div_ifc()" id="link_div_ifc">IFC <span class="badge bg-warning float-end" id="notif_ifc_non_rkap"></span> </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:;" onclick="div_selesai()" id="link_div_selesai">Selesai <span class="badge bg-dark float-end" id="notif_selesai_non_rkap"></span> </a>
                            </li>
                        </ul>
                    </div>
                    <!-- End Tab -->
            ...
            "render": function(data, type, full, meta) {
                ...
                if (full.pekerjaan_status == '0') return '<center>-</center>';
                    ...
                    return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Review" onclick="fun_detail(this.id,this.name)"><i style="background-color:red; color:white" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal_usulan">Approve</i></a></center>';
                            ...
                            // pekerjaan 3
                else if (full.pekerjaan_status == '3' && $('#session_poscode').val() == 'E53000000') return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Approve" onclick="fun_detail(this.id,this.name)"><i style="background-color:red; color:white" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal_usulan">Approve</i></a></center>';
                else if (full.pekerjaan_status == '3' && $('#session_poscode').val() != 'E53000000') return '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Approve" onclick="fun_detail(this.id,this.name)"><i class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_usulan">Detail</i></a></center>';
...
$('#table_selesai').DataTable({
    ...
    {
        "render": function(data, type, full, meta) {
            return (full.is_allow == 'y') ? '<center><a href="javascript:;" id="' + full.pekerjaan_id + '" name="' + full.pekerjaan_status + '" title="Detail" onclick="fun_detail(this.id,this.name)"><i class="btn btn-info btn-sm">Detail</i></a></center>' : '<center>-</center>';
        }
    },
    ]
}).columns.adjust();
