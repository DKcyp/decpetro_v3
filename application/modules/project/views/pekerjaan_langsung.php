...
<div class="page-content">
  ...
  $dataKlasifikasi = $this->db->query("SELECT *,case
            when klasifikasi_pekerjaan_rkap = 'y' then 'RKAP'
            when klasifikasi_pekerjaan_rkap = 'n' then 'NON RKAP'
            end as klasifikasi_pekerjaan_rkap_nama FROM global.global_klasifikasi_pekerjaan ORDER BY klasifikasi_pekerjaan_rkap DESC,klasifikasi_pekerjaan_nama ASC")->result_array();
  ?>
          ...
          <form id="form_modal" enctype="multipart/form-data">
                ...
                <select id="id_klasifikasi_pekerjaan" name="id_klasifikasi_pekerjaan" class="form-control" required>
                  <!-- <option value="">- Pilih Klasifikasi Dokumen -</option>
                                    <?php foreach ($dataKlasifikasi as $value) : ?>
                                        <option value="<?php echo $value['klasifikasi_pekerjaan_id'] ?>"><?php echo $value['klasifikasi_pekerjaan_nama'] . ' (' . $value['klasifikasi_pekerjaan_rkap_nama'] . ')' ?></option>
                                    <?php endforeach ?> -->
                </select>
            ...
            <div class="card-body row">
              <div class="form-group row col-md-12">
                ...
                <select name="ref_unit_kerja[]" id="ref_unit_kerja" class="form-control select2"></select>
              </div>
            </div>
            <div class="card-body row">
              <div class="form-group row col-md-12">
                ...
                <table id="dg_document" title="Document" style="width:100%" toolbar="#toolbar" idField="id" rownumbers="true" fitColumns="true" singleSelect="true">
                </table>
                <div id="toolbar">
  ...
  <div class="modal fade" id="modal_pekerjaan" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form id="form_modal_edit" enctype="multipart/form-data">
            ...
            <div class="card-body row">
              <div class="form-group row col-md-12">
                ...
                <select name="pekerjaan_status_edit" id="pekerjaan_status_edit" class="form-control col-md-8 select2">
                  <option value="">Berjalan</option>
                  <option value="">IFI</option>
                  <option value="">IFA</option>
                  <option value="">IFC</option>
                  <option value="">IFT</option>
                  <option value="">IFR</option>
                </select>
              </div>
            </div>
            <div class="card-body row">
            ...
            <div class="card-body row">
              <div class="form-group row col-md-12">
                <label class="col-md-4">Tahun Pekerjaan *</label>
                <!-- <input type="text" name="pekerjaan_tahun_edit" id="pekerjaan_tahun_edit" class="form-control col-md-8" maxlength="4" onkeypress="return numberOnly(event);" onkeyup="func_ganti_no_pekerjaan(this.value)" value="<?= date('Y') ?>"> -->
                <select name="pekerjaan_tahun_edit" id="pekerjaan_tahun_edit" class="form-control col-md-8" maxlength="4">
                  <?php for ($year = 2022; $year <= date("Y"); $year++) : ?>
                      <?php $selected = ($year == date("Y")) ? 'selected' : ''; ?>
                      <option value="<?php echo $year; ?>" <?php echo $selected; ?>><?php echo $year; ?></option>
                  <?php endfor; ?>
            ...
            <div class="card-body row">
              <div class="col-12 mb-3">
                ...
                <table id="dg_document_pekerjaan" title="Document" style="width:100%" toolbar="#toolbar_pekerjaan" idField="id" rownumbers="true" fitColumns="true" singleSelect="true">
                </table>
              ...
              <div class="col-12 mb-3 mt-3">
                <table id="dg_document_non_hps" title="Document Non HPS" style="width:100%" toolbar="#toolbar_non_hps" idField="id" rownumbers="true" fitColumns="true" singleSelect="true">
                  <thead>
                    <tr>
              ...
              <div class="col-12 mb-3 mt-3">
                <table id="dg_document_hps" title="Document HPS" style="width:100%" toolbar="#toolbar_hps" idField="id" rownumbers="true" fitColumns="true" singleSelect="true">
                  <thead>
                    <tr>
                      <th field="pekerjaan_dokumen_nama" width="50" editor="{type:'label'}">Nama</th>
                      <th field="pekerjaan_dokumen_file" width="50" editor="{type:'label'}">File</th>
...
<div class="modal fade" id="modal_aksi" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Pekerjaan</h4>
        ...
        <form id="form_modal_aksi" enctype="multipart/form-data">
          ...
          <div class="card-body row">
            <div class="form-group row col-md-12">
              <label class="col-md-4">Status Pekerjaan</label>
              <select name="pekerjaan_status_edit" id="pekerjaan_status_edit" class="form-control col-md-8 select2">
                <option value="5">Berjalan</option>
                <option value="8">IFI</option>
                <option value="8">IFA</option>
                <option value="11">IFC</option>
                <option value="11">IFT</option>
                <option value="11">IFR</option>
              </select>
            </div>
          </div>
          <div class="card-body row">
          ...
          <div class="card-body row">
            <div class="form-group row col-md-12">
              <label class="col-md-4">Klasifikasi Pekerjaan</label>
              <select name="id_klasifikasi_pekerjaan_aksi" id="id_klasifikasi_pekerjaan_aksi" class="form-control col-md-8 select2" required></select>
          ...
          <div class="card-body row">
            <div class="form-group row col-md-12">
              <label class="col-md-4">Nilai HPS</label>
          ...
          <div class="card-body row">
            <div class="form-group row col-md-12">
              <label class="col-md-4">Nilai Kontrak</label>
          ...
          <div class="card-body row">
            <div class="form-group row col-md-12">
              <label class="col-md-4">Persentase</label>
          ...
          <div class="card-body row">
            <div class="form-group row col-md-12">
              ...
              <table id="dg_document_aksi" title="Document" style="width:100%" toolbar="#toolbar_aksi" idField="id" rownumbers="true" fitColumns="true" singleSelect="true">
              </table>
              <div id="toolbar_aksi">
          ...
          <div class="col-12 mb-3 mt-3">
            <table id="dg_document_non_hps_aksi" title="Document Non HPS" style="width:100%" toolbar="#toolbar_non_hps_aksi" idField="id" rownumbers="true" fitColumns="true" singleSelect="true">
              <thead>
                <tr>
                  <th field="pekerjaan_dokumen_nama" width="50" editor="{type:'label'}">Nama</th>
                  <th field="pekerjaan_dokumen_file" width="50" editor="{type:'label'}">File</th>
          ...
          <div class="col-12 mb-3 mt-3">
            <table id="dg_document_hps_aksi" title="Document HPS" style="width:100%" toolbar="#toolbar_hps_aksi" idField="id" rownumbers="true" fitColumns="true" singleSelect="true">
              <thead>
                <tr>
                  <th field="pekerjaan_dokumen_nama" width="50" editor="{type:'label'}">Nama</th>
                  <th field="pekerjaan_dokumen_file" width="50" editor="{type:'label'}">File</th>
...
<script type="text/javascript">
  $(function() {
    ...
    $('#id_klasifikasi_pekerjaan_edit').select2({
      ...
      ajax: {
        delay: 250,
        url: '<?= base_url('project/pekerjaan_usulan/getListKlasifikasiPekerjaan') ?>',
        dataType: 'json',
        type: 'GET',
  ...
  function fun_detail_modal(id, val) {
    ...
    $.getJSON('<?= base_url('project/pekerjaan_langsung/getPekerjaanLangsung') ?>', {
      ...
      $('#pekerjaan_nilai_hps_aksi').val(json.pekerjaan_nilai_hps_jumlah);
  ...
  function fun_close_edit() {
    ...
    $('#id_klasifikasi_pekerjaan_edit').empty();
    // alert
    $('#pekerjaan_waktu_edit_alert').hide();
    $('#pic_no_telp_edit_alert').hide();
    $('#pekerjaan_judul_edit_alert').hide();
  ...
  function func_ganti_no_pekerjaan(value) {
    $.getJSON('<?= base_url() ?>project/pekerjaan_usulan/getMaxNomor', {
      id_pekerjaan: $('#pekerjaan_id_edit').val(),
      tahun: value,
      id_klasifikasi_pekerjaan: $('#id_klasifikasi_pekerjaan_edit').val(),
    }, function(json, textStatus) {
      $('#pekerjaan_nomor_edit').val(json);
